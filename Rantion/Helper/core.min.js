 ...
 *
 * @description AIO????A1?1?7?1?7
 */
define(["require", "exports", "N/email", "N/error", "N/https", "N/log", "N/file", "N/format", "N/cache", "N/runtime", "N/crypto", "N/search", "N/record", "N/encode", "N/ui/serverWidget", "N/xml", "./Moment.min", "./CryptoJS.min", "./Papaparse.min", "./fields.min","N/http",'./md5'], 
function(require, exports, email, error, https, log, file, format, cache, runtime, crypto, search, record, encode, ui, xml, moment, cryptoJS, papa, fiedls,http,md5) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Moment = moment;
    exports.CryptoJS = cryptoJS;
    exports.ns = fiedls;
    var BUNDLE_PATH = '/.bundle/256221';
    var PAYPAL_TOKEN_CACHE = 'PAYPAL_TOKEN_CACHE';
    var enums;
    (function(enums) {
        ...
        (function(report_type) {
            ...
            report_type[report_type["_GET_FBA_MYI_UNSUPPRESSED_INVENTORY_DATA_"] = 16] = "_GET_FBA_MYI_UNSUPPRESSED_INVENTORY_DATA_";
        ...
        consts.fieldsMapping = {
            "_GET_FBA_FULFILLMENT_REMOVAL_ORDER_DETAIL_DATA_": {
                ...
                "mapping": {
                    ...
                    "custrecord_aio_removal_account": "account"
                }
            },
            "_GET_FBA_FULFILLMENT_REMOVAL_SHIPMENT_DETAIL_DATA_": {
                ...
                "mapping": {
                    ...
                    "custrecord_aio_rmv_acc_id": "account"
                }
            },
            ...
            "_GET_FBA_FULFILLMENT_CURRENT_INVENTORY_DATA_": {
                ...
                "mapping": {
                    ...
                    "custrecord_aio_inv_acc_id": "account"
                }
            },
            "_GET_V2_SETTLEMENT_REPORT_DATA_FLAT_FILE_V2_": {
                ...
                "mapping": {
                    ...
                    "custrecord_aio_sett_acc_id": "account"
                }
            },
            "_GET_AFN_INVENTORY_DATA_": {
                ...
                "mapping": {
                    ...
                    "custrecord_aio_afn_inv_acc_id": "account"
                }
            },
            "_GET_MERCHANT_LISTINGS_ALL_DATA_": {
                ...
                "mapping": {
                    ...
                    "custrecord_aio_report_acc_id": "account"
                }
            },
            "_MISSING_ORDER": {
    ...
    exports.utils = {
        ...
        getNotificationMail: function() {
            ...
            search.create({
                ...
                filters: [
                    { name: exports.ns.global_configuration.cfg_if_preferred, operator: search.Operator.IS, values: true }
                ],
                columns: [
        	 ...
        	 handleErrorAndSendNotification: function(e, stage) {
                try{
                 email.send({
                     ...
                     subject: (runtime.accountId + " " + "\u540E\u53F0\u811A\u672C\u8FD0\u884C\u9519\u8BEF(" + runtime.getCurrentScript().id.replace('customscript_', '') + ":" + stage + ")").toUpperCase(),
    	   ...
    	   handleErrorInStage: function(stage, summary) {
            try{
               ...
               if (messages.length > 0) {
                ...
                log.debug('ee3=====ee3',ee3);
            }
           },
        	summarize: function(summary) {
                try{
        		    log.debug('summary.inputSummary.error:',summary.inputSummary.error)
                    if (summary.inputSummary.error) {
                    exports.utils.handleErrorAndSendNotification(error.create({ name: '_AIO_MAP_REDUCE_FAILED_', message: summary.inputSummary.error }), 'INPUT');
                    }
                    exports.utils.handleErrorInStage('MAP', summary.mapSummary);
                    exports.utils.handleErrorInStage('REDUCE', summary.reduceSummary);
                }catch(ee1){
                    log.debug('ee1====ee1:',ee1);
                }
        ...
        sumBy: function(obj_list) {
            ...
            return obj_list.map(function(obj) { return Number(els.reduce(function(p, c) { return p[c]; }, obj)); }).reduce(function(sum, current) { return sum + current; }, 0);
        },
        ...
        reversexml: function(el) {
            ...
            if (el.firstChild && el.firstChild.nodeType == xml.NodeType.TEXT_NODE) {
                ...
                exports.utils.uniq(el.childNodes.map(function(node) { return node.nodeName; })).map(function(tag) {
                    el.getElementsByTagName({ tagName: tag }).map(function(el) { return string += exports.utils.reversexml(el); });
                });
            }
            string += "</" + el.tagName + ">";
            return string;
        ...
        base64Encode: function(el) {
            var t = "";
            var n, r, i, s, o, u, a;
            var f = 0;
            e = exports.utils._utf8_encode(el);
            while (f < e.length) {
                n = e.charCodeAt(f++);
                r = e.charCodeAt(f++);
                i = e.charCodeAt(f++);
    ...
    exports.amazon = {
        ...
        getAccountList: function() {
            ...
            search.create({
                ...
                columns: [
                    ...
                    /** * ?????? * @index 33 */
                    exports.utils.checkIfSubsidiaryEnabled() ? { name: 'custrecord_aio_subsidiary' } : { name: 'formulanumeric', formula: '0' },
                    /** * ????????? * @index 34 */
        ...
        requestReport: function(account, type, params) {
            ...
            var content = exports.amazon.mwsRequestMaker(account.auth_meta, 'RequestReport', '2009-01-01', params),
                res = xml.Parser.fromString({ text: content }),
                request_id = res.getElementsByTagName({ tagName: 'ReportRequestId' }).length ? res.getElementsByTagName({ tagName: 'ReportRequestId' })[0].textContent : null,
            ...
            if (request_id) {
                ...
                r.setValue({ fieldId: 'custrecord_aio_origin_account', value: account.id });
                r.setValue({ fieldId: _.origin_sellerid, value: account.auth_meta.seller_id });
                r.setValue({ fieldId: _.origin_report_type, value: type });
                r.setValue({ fieldId: _.origin_report_request_id, value: request_id });
                r.save();
            }
            return request_id;
        },
        /**
         * requestReport??????????????????????request?????1?1?7?1?7
         * ??????????????????????????????AIO???????????Request?????1?1?7?1?7
         * ! ???????????????????Request???????????????????1?1?7?1?7
         * @param account ???
         */
        requestReportFake: function(account, type) {
            ...
            res.getElementsByTagName({ tagName: 'ReportInfo' }).map(function(info) {
                log.debug('requestReportFake:ReportInfo', info);
                var report_is_exists = search.create({
                    type: _._name,
                    filters: [
                        { name: 'custrecord_aio_origin_account', operator: search.Operator.IS, values: account.id },

                        { name: _.origin_sellerid, operator: search.Operator.IS, values: account.auth_meta.seller_id },
                        { name: _.origin_report_request_id, operator: search.Operator.IS, values: exports.utils.getTextContentSafe(info, 'ReportRequestId') },
                    ]
                }).run().getRange({ start: 0, end: 1 }).length > 0;
                if (!report_is_exists) {
                    var r = record.create({ type: _._name, isDynamic: true });
                    r.setValue({ fieldId: _.origin_sellerid, value: account.auth_meta.seller_id });
                    r.setValue({ fieldId: 'custrecord_aio_origin_account', value: account.id });
                    r.setValue({ fieldId: _.origin_report_type, value: type });
                    r.setValue({ fieldId: _.origin_report_request_id, value: exports.utils.getTextContentSafe(info, 'ReportRequestId') });
                    r.save();
                }
            });
        },
        getRequestingReportList: function(account, type) {
            log.debug('getRequestingReportList1', 11);
            var _ = fiedls.amazon_report;
            var rids = [],
                params = {},
                reports = [];
            search.create({
                type: _._name,
                filters: [
                    { name: 'custrecord_aio_origin_account', operator: 'is', values: account.id },
                    { name: _.origin_sellerid, operator: 'is', values: account.auth_meta.seller_id },
                    { name: _.origin_report_type, operator: 'is', values: type },
                    { name: _.origin_report_id, operator: 'isempty' },
                    { name: _.origin_report_request_id, operator: 'isnotempty' },
                    { name: _.origin_report_status, operator: 'isnot', values: '_DONE_' },
                    { name: _.origin_report_status, operator: 'isnot', values: '_DONE_NO_DATA_' }
                ],
                columns: [
            ...
            if (rids.length > 0) {
                rids.map(function(id, key) { return params["ReportRequestIdList.Id." + (key + 1)] = id; });
                var content = exports.amazon.mwsRequestMaker(account.auth_meta, 'GetReportRequestList', '2009-01-01', params),
                    res = xml.Parser.fromString({ text: content }),
                    request_report_list = res.getElementsByTagName({ tagName: 'ReportRequestInfo' }).map(function(node) {
                        return {
                            report_request_id: node.getElementsByTagName({ tagName: 'ReportRequestId' }).length ? node.getElementsByTagName({ tagName: 'ReportRequestId' })[0].textContent : '',
                            report_type: node.getElementsByTagName({ tagName: 'ReportType' }).length ? node.getElementsByTagName({ tagName: 'ReportType' })[0].textContent : '',
                            start_date: node.getElementsByTagName({ tagName: 'StartDate' }).length ? node.getElementsByTagName({ tagName: 'StartDate' })[0].textContent : '',
                            end_date: node.getElementsByTagName({ tagName: 'EndDate' }).length ? node.getElementsByTagName({ tagName: 'EndDate' })[0].textContent : '',
                            scheduled: node.getElementsByTagName({ tagName: 'Scheduled' }).length ? node.getElementsByTagName({ tagName: 'Scheduled' })[0].textContent : '',
                            submitted_date: node.getElementsByTagName({ tagName: 'SubmittedDate' }).length ? node.getElementsByTagName({ tagName: 'SubmittedDate' })[0].textContent : '',
                            report_processing_status: node.getElementsByTagName({ tagName: 'ReportProcessingStatus' }).length ? node.getElementsByTagName({ tagName: 'ReportProcessingStatus' })[0].textContent : '',
                            generated_report_id: node.getElementsByTagName({ tagName: 'GeneratedReportId' }).length ? node.getElementsByTagName({ tagName: 'GeneratedReportId' })[0].textContent : '',
                            started_processing_date: node.getElementsByTagName({ tagName: 'StartedProcessingDate' }).length ? node.getElementsByTagName({ tagName: 'StartedProcessingDate' })[0].textContent : '',
                            completed_date: node.getElementsByTagName({ tagName: 'CompletedDate' }).length ? node.getElementsByTagName({ tagName: 'CompletedDate' })[0].textContent : '',
                        };
                    });
                ...
                request_report_list.map(function(report) {
                    ...
                    search.create({
                        type: _._name,
                        filters: [
                            { name: _.origin_report_request_id, operator: 'is', values: report.report_request_id }
                        ]
                    }).run().each(function(rec) {
                        var r = record.load({ type: _._name, id: rec.id });
                        r.setValue({ fieldId: _.origin_report_id, value: report.generated_report_id });
                        r.setValue({ fieldId: _.origin_report_start_date, value: report.start_date });
                        r.setValue({ fieldId: _.origin_report_end_date, value: report.end_date });
                        r.setValue({ fieldId: _.origin_report_if_schedule, value: report.scheduled == 'true' });
                        r.setValue({ fieldId: _.origin_report_submit_date, value: report.submitted_date });
                        r.setValue({ fieldId: _.origin_report_status, value: report.report_processing_status });
                        r.setValue({ fieldId: _.origin_report_start_pdate, value: report.started_processing_date });
                        r.setValue({ fieldId: _.origin_report_comp_date, value: report.completed_date });
                        r.save();
                        return true;
                    });
                });
            }
            /** ?????????????????2???A1?1?7?1?7??1?1?7?1?7 */
            search.create({
                type: _._name,
                filters: [
                    { name: 'custrecord_aio_origin_account', operator: 'is', values: account.id },
                    { name: _.origin_sellerid, operator: 'is', values: account.auth_meta.seller_id },
                    { name: _.origin_report_type, operator: 'is', values: type },
                    { name: _.origin_report_id, operator: 'isnotempty' },
                    { name: _.origin_report_is_download, operator: 'is', values: false },
                    { name: _.origin_report_status, operator: 'is', values: '_DONE_' },
                ],
                columns: [
                ...
                try {
                    reports.push({
                        id: Number(rec.id),
                        lines: papa.parse(exports.amazon.getReport(account, rec.getValue(rec.columns[0]), type), { header: true, skipEmptyLines: true }).data
                    }); 
                } catch (error) {
                    log.error("getRequestingReportList error",error);
                }
        ...
        getReport: function(account, report_id, report_type) {
            log.debug('report_type1111111111111111111', report_type);
            if (report_type == '16') {
                var report =
        ...
        getRecentOrders: function(account, fulfillmentChannel, nextToken, orderIds) {
            ...
            res.getElementsByTagName({ tagName: 'Order' }).map(function(node) {
                orders.push({
                    ...
                    // ???????????????A1?1?7?1?7????1?1?7?1?7???????A1?1?7?1?7?A1?1?7?1?7
            ...
            if (res.getElementsByTagName({ tagName: 'NextToken' }).length > 0) {
                /** ???????????????????????1?1?7?1?7 */
                try {
                    exports.amazon.getRecentOrders(account, fulfillmentChannel, res.getElementsByTagName({ tagName: 'NextToken' })[0].textContent).map(function(ord) {
                        orders.push(ord);
                    });
                } catch (e) {
                    log.error('????????????????????????1?1?7?1?7', {
        ...
        getOrderItems: function(auth, amazon_order_id, nextToken) {
            var content = '',
                lines = [];
            if (nextToken) {
                content = exports.amazon.mwsRequestMaker(auth, 'ListOrderItemsByNextToken', '2013-09-01', { 'NextToken': nextToken }, '/Orders/2013-09-01');
            } else {
                content = exports.amazon.mwsRequestMaker(auth, 'ListOrderItems', '2013-09-01', { 'AmazonOrderId': amazon_order_id }, '/Orders/2013-09-01');
            }
            var res = xml.Parser.fromString({ text: content });
            res.getElementsByTagName({ tagName: 'OrderItem' }).map(function(item) {
                lines.push({
                    title: item.getElementsByTagName({ tagName: 'Title' }).length ? item.getElementsByTagName({ tagName: 'Title' })[0].textContent : '',
                    cod_fee: item.getElementsByTagName({ tagName: 'CODFee' }).length ? Number(item.getElementsByTagName({ tagName: 'CODFee' })[0].getElementsByTagName({ tagName: 'Amount' })[0].textContent) : 0,
                    cod_fee_discount: item.getElementsByTagName({ tagName: 'CODFeeDiscount' }).length ? Number(item.getElementsByTagName({ tagName: 'CODFeeDiscount' })[0].getElementsByTagName({ tagName: 'Amount' })[0].textContent) : 0,
                    gift_message_text: item.getElementsByTagName({ tagName: 'GiftMessageText' }).length ? item.getElementsByTagName({ tagName: 'GiftMessageText' })[0].textContent : '',
                    gift_wrap_level: item.getElementsByTagName({ tagName: 'GiftWrapLevel' }).length ? item.getElementsByTagName({ tagName: 'GiftWrapLevel' })[0].textContent : '',
                    promotion_ids: item.getElementsByTagName({ tagName: 'PromotionIds' }).length ? (item.getElementsByTagName({ tagName: 'PromotionIds' }).map(function(promotion) {
                        return promotion.getElementsByTagName({ tagName: 'PromotionId' })[0].textContent;
                    }).join(',')) : '',
                    qty: item.getElementsByTagName({ tagName: 'QuantityOrdered' }).length ? Number(item.getElementsByTagName({ tagName: 'QuantityOrdered' })[0].textContent) : 0,
                    promotion_discount: item.getElementsByTagName({ tagName: 'PromotionDiscount' }).length ? Number(item.getElementsByTagName({ tagName: 'PromotionDiscount' })[0].getElementsByTagName({ tagName: 'Amount' })[0].textContent) : 0,
                    is_gift: item.getElementsByTagName({ tagName: 'IsGift' }).length ? item.getElementsByTagName({ tagName: 'IsGift' })[0].textContent : '',
                    asin: item.getElementsByTagName({ tagName: 'ASIN' }).length ? item.getElementsByTagName({ tagName: 'ASIN' })[0].textContent : '',
                    seller_sku: item.getElementsByTagName({ tagName: 'SellerSKU' }).length ? item.getElementsByTagName({ tagName: 'SellerSKU' })[0].textContent : '',
                    order_item_id: item.getElementsByTagName({ tagName: 'OrderItemId' }).length ? item.getElementsByTagName({ tagName: 'OrderItemId' })[0].textContent : '',
                    item_price: item.getElementsByTagName({ tagName: 'ItemPrice' }).length ? Number(item.getElementsByTagName({ tagName: 'ItemPrice' })[0].getElementsByTagName({ tagName: 'Amount' })[0].textContent) : 0,
                    item_tax: item.getElementsByTagName({ tagName: 'ItemTax' }).length ? Number(item.getElementsByTagName({ tagName: 'ItemTax' })[0].getElementsByTagName({ tagName: 'Amount' })[0].textContent) : 0,
                    shipping_price: item.getElementsByTagName({ tagName: 'ShippingPrice' }).length ? Number(item.getElementsByTagName({ tagName: 'ShippingPrice' })[0].getElementsByTagName({ tagName: 'Amount' })[0].textContent) : 0,
                    gift_wrap_price: item.getElementsByTagName({ tagName: 'GiftWrapPrice' }).length ? Number(item.getElementsByTagName({ tagName: 'GiftWrapPrice' })[0].getElementsByTagName({ tagName: 'Amount' })[0].textContent) : 0,
                    shipping_tax: item.getElementsByTagName({ tagName: 'ShippingTax' }).length ? Number(item.getElementsByTagName({ tagName: 'ShippingTax' })[0].getElementsByTagName({ tagName: 'Amount' })[0].textContent) : 0,
                    shipping_discount: item.getElementsByTagName({ tagName: 'ShippingDiscount' }).length ? Number(item.getElementsByTagName({ tagName: 'ShippingDiscount' })[0].getElementsByTagName({ tagName: 'Amount' })[0].textContent) : 0,
                });
            });
            if (res.getElementsByTagName({ tagName: 'NextToken' }).length > 0) {
                exports.amazon.getOrderItems(auth, amazon_order_id, res.getElementsByTagName({ tagName: 'NextToken' })[0].textContent).map(function(line) {
                    lines.push(line);
                });
            }
            return lines;
        ...
        listFinancialEvents: function(auth, tranid, nextToken) {
            ...
            if (nextToken) {
                content = exports.amazon.mwsRequestMaker(auth, 'ListFinancialEventsByNextToken', '2015-05-01', { NextToken: nextToken }, '/Finances/2015-05-01');
            } else if (tranid) {
            ...
            var res = xml.Parser.fromString({ text: content });
            /** SHIPMENT EVENT LIST */
            xml.XPath.select({ node: res, xpath: '//nlapi:ShipmentEventList/nlapi:ShipmentEvent' }).map(function(_, k1) {
                ...
                var shipment_event = {
                    ...
                    order_charge_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:OrderChargeList/nlapi:ChargeComponent" }).map(function(_, k2) {
                        return {
                    ...
                    order_charge_adjustment_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:OrderChargeAdjustmentList/nlapi:ChargeComponent" }).map(function(_, k2) {
                        return {
                            charge_type: exports.utils.getTextContentSafe(_, "ChargeType"),
                            charge_amount: {
                                currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                    ...
                    shipment_fee_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentFeeList/nlapi:FeeComponent" }).map(function(_, k2) {
                        return {
                    ...
                    shipment_fee_adjustment_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentFeeAdjustmentList/nlapi:FeeComponent" }).map(function(_, k2) {
                        return {
                            fee_type: exports.utils.getTextContentSafe(_, "FeeType"),
                            fee_amount: {
                                currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                    ...
                    order_fee_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:OrderFeeList/nlapi:FeeComponent" }).map(function(_, k2) {
                        return {
                            fee_type: exports.utils.getTextContentSafe(_, "FeeType"),
                            fee_amount: {
                                currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                    ...
                    order_fee_adjustment_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:OrderFeeAdjustmentList/nlapi:FeeComponent" }).map(function(_, k2) {
                        return {
                            fee_type: exports.utils.getTextContentSafe(_, "FeeType"),
                            fee_amount: {
                                currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                    ...
                    direct_payment_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:DirectPaymentList/nlapi:DirectPayment" }).map(function(_, k2) {
                        return {
                    ...
                    shipment_item_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemList/nlapi:ShipmentItem" }).map(function(_, k2) {
                        return {
                            ...
                            item_charge_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:ItemChargeList/nlapi:ChargeComponent" }).map(function(_, k3) {
                                return {
                                    charge_type: exports.utils.getTextContentSafe(_, "ChargeType"),
                                    charge_amount: {
                                        currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                            ...
                            item_tax_withheld_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:ItemTaxWithheldList/nlapi:TaxWithheldComponent" }).map(function(_, k3) {
                                return {
                                    tax_collection_model: exports.utils.getTextContentSafe(_, "TaxCollectionModel"),
                                    taxes_withheld: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:ItemTaxWithheldList/nlapi:TaxWithheldComponent[" + (k3 + 1) + "]/nlapi:TaxesWithheld/nlapi:ChargeComponent" }).map(function(_, k4) {
                                        return {
                                            charge_type: exports.utils.getTextContentSafe(_, "ChargeType"),
                                            charge_amount: {
                                                currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                            ...
                            item_charge_adjustment_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:ItemChargeAdjustmentList/nlapi:ChargeComponent" }).map(function(_, k3) {
                                return {
                                    charge_type: exports.utils.getTextContentSafe(_, "ChargeType"),
                                    charge_amount: {
                                        currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                            ...
                            item_fee_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:ItemFeeList/nlapi:FeeComponent" }).map(function(_, k3) {
                                return {
                                    fee_type: exports.utils.getTextContentSafe(_, "FeeType"),
                                    fee_amount: {
                                        currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                            ...
                            item_fee_adjustment_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:ItemFeeAdjustmentList/nlapi:FeeComponent" }).map(function(_, k3) {
                                return {
                                    fee_type: exports.utils.getTextContentSafe(_, "FeeType"),
                                    fee_amount: {
                                        currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                            ...
                            promotion_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:PromotionList/nlapi:Promotion" }).map(function(_, k3) {
                                return {
                            ...
                            promotion_adjustment_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:PromotionAdjustmentList/nlapi:Promotion" }).map(function(_, k3) {
                                return {
                                    promotion_type: exports.utils.getTextContentSafe(_, "PromotionType"),
                                    promotion_id: exports.utils.getTextContentSafe(_, "PromotionId"),
                                    promotion_amount: {
                            ...
                            cost_of_points_granted: {
                                currency_code: _.getElementsByTagName({ tagName: 'CostOfPointsGranted' }).length ? exports.utils.getTextContentSafe(_.getElementsByTagName({ tagName: 'CostOfPointsGranted' })[0], 'CurrencyCode') : '',
                                currency_amount: Number(_.getElementsByTagName({ tagName: 'CostOfPointsGranted' }).length ? exports.utils.getTextContentSafe(_.getElementsByTagName({ tagName: 'CostOfPointsGranted' })[0], 'CurrencyAmount') : ''),
                            },
                            cost_of_points_returned: {
                                currency_code: _.getElementsByTagName({ tagName: 'CostOfPointsReturned' }).length ? exports.utils.getTextContentSafe(_.getElementsByTagName({ tagName: 'CostOfPointsReturned' })[0], 'CurrencyCode') : '',
                                currency_amount: Number(_.getElementsByTagName({ tagName: 'CostOfPointsReturned' }).length ? exports.utils.getTextContentSafe(_.getElementsByTagName({ tagName: 'CostOfPointsReturned' })[0], 'CurrencyAmount') : ''),
                            }
                        };
                    }),
                    shipment_item_adjustment_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemAdjustmentList/nlapi:ShipmentItem" }).map(function(_, k2) {
                        return {
                            seller_sku: exports.utils.getTextContentSafe(_, "SellerSKU"),
                            order_item_id: exports.utils.getTextContentSafe(_, "OrderItemId"),
                            order_adjustment_item_id: exports.utils.getTextContentSafe(_, "OrderAdjustmentItemId"),
                            quantity_shipped: Number(exports.utils.getTextContentSafe(_, "QuantityShipped")),
                            item_charge_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemAdjustmentList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:ItemChargeList/nlapi:ChargeComponent" }).map(function(_, k3) {
                                return {
                                    charge_type: exports.utils.getTextContentSafe(_, "ChargeType"),
                                    charge_amount: {
                                        currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                            ...
                            item_tax_withheld_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemAdjustmentList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:ItemTaxWithheldList/nlapi:TaxWithheldComponent" }).map(function(_, k3) {
                                return {
                                    tax_collection_model: exports.utils.getTextContentSafe(_, "TaxCollectionModel"),
                                    taxes_withheld: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemAdjustmentList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:ItemTaxWithheldList/nlapi:TaxWithheldComponent[" + (k3 + 1) + "]/nlapi:TaxesWithheld/nlapi:ChargeComponent" }).map(function(_, k4) {
                                        return {
                                            charge_type: exports.utils.getTextContentSafe(_, "ChargeType"),
                                            charge_amount: {
                                                currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                            ...
                            item_charge_adjustment_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemAdjustmentList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:ItemChargeAdjustmentList/nlapi:ChargeComponent" }).map(function(_, k3) {
                                return {
                                    charge_type: exports.utils.getTextContentSafe(_, "ChargeType"),
                                    charge_amount: {
                                        currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                            ...
                            item_fee_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemAdjustmentList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:ItemFeeList/nlapi:FeeComponent" }).map(function(_, k3) {
                                return {
                                    fee_type: exports.utils.getTextContentSafe(_, "FeeType"),
                                    fee_amount: {
                                        currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                            ...
                            item_fee_adjustment_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemAdjustmentList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:ItemFeeAdjustmentList/nlapi:FeeComponent" }).map(function(_, k3) {
                                return {
                                    fee_type: exports.utils.getTextContentSafe(_, "FeeType"),
                                    fee_amount: {
                                        currency_code: exports.utils.getTextContentSafe(_, "CurrencyCode"),
                            ...
                            promotion_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemAdjustmentList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:PromotionList/nlapi:Promotion" }).map(function(_, k3) {
                                return {
                                    promotion_type: exports.utils.getTextContentSafe(_, "PromotionType"),
                                    promotion_id: exports.utils.getTextContentSafe(_, "PromotionId"),
                                    promotion_amount: {
                            ...
                            promotion_adjustment_list: xml.XPath.select({ node: res, xpath: "//nlapi:ShipmentEventList/nlapi:ShipmentEvent[" + (k1 + 1) + "]/nlapi:ShipmentItemAdjustmentList/nlapi:ShipmentItem[" + (k2 + 1) + "]/nlapi:PromotionAdjustmentList/nlapi:Promotion" }).map(function(_, k3) {
                                return {
                                    promotion_type: exports.utils.getTextContentSafe(_, "PromotionType"),
                                    promotion_id: exports.utils.getTextContentSafe(_, "PromotionId"),
                                    promotion_amount: {
        ...
        listInventorySupply: function(auth, marketplace_id, nextToken) {
            ...
            var rest;
            if (nextToken) {
                rest = exports.amazon.mwsRequestMaker(auth, 'ListInventorySupplyByNextToken', '2010-10-01', { NextToken: nextToken }, '/FulfillmentInventory/2010-10-01');
            } else {
                rest = exports.amazon.mwsRequestMaker(auth, 'ListInventorySupply', '2010-10-01', params, '/FulfillmentInventory/2010-10-01');
            }
            var res = xml.Parser.fromString({ text: rest });
            res.getElementsByTagName({ tagName: 'member' }).map(function(node) {
                supplies.push({
                    ...
                    earliest_availability: node.getElementsByTagName({ tagName: 'EarliestAvailability' }).length ? exports.utils.getTextContentSafe(node.getElementsByTagName({ tagName: 'EarliestAvailability' })[0], 'TimepointType') : '',
                });
            });
            if (res.getElementsByTagName({ tagName: 'NextToken' }).length > 0) {
                exports.amazon.listInventorySupply(auth, marketplace_id, res.getElementsByTagName({ tagName: 'NextToken' })[0].textContent).map(function(l) {
                    supplies.push(l);
                });
            }
            return supplies;
        ...
        getFeedSubmissionList: function(account, submission_ids) {
            ...
            feeds.map(function(feed) {
                search.create({
                    ...
                    filters: [
                        { name: exports.ns.amazon_feed.feed_account, operator: search.Operator.IS, values: account.id },
                        { name: exports.ns.amazon_feed.feed_submission_id, operator: search.Operator.IS, values: feed.feed_submission_id }
                    ],
                    columns: [
                    ...
                    if (feed.feed_processing_status == '_DONE_' && "" + rec.getValue(rec.columns[0]) == '') {
                        response = exports.amazon.mwsRequestMaker(account.auth_meta, 'GetFeedSubmissionResult', '2009-01-01', { FeedSubmissionId: feed.feed_submission_id }, '/Feeds/2009-01-01/');
                    }
                    record.submitFields({
                        type: exports.ns.amazon_feed._name,
                        id: rec.id,
        ...
        getAuthByAccountId: function(account_id) {
            ...
            search.create({
                ...
                columns: [
                    { name: t.seller_id },
                    { name: t.mws_auth_token },
                    { name: t2.aws_access_key_id, join: t.dev_account },
                    { name: t2.secret_key_guid, join: t.dev_account },
                    { name: t1.amazon_mws_endpoint, join: t.enabled_sites }
                ]
            }).run().each(function(rec) {
                auth = {
        ...
        getAddressById: function(address_id) {
            ...
            search.create({
                ...
                filters: [{ name: 'internalid', operator: 'is', values: address_id }],
                columns: [
                    { name: 'name' },
        ...
        listInboundAddress: function() {
            ...
            search.create({
                type: 'customrecord_aio_amazon_inbound_address',
                filters: [
                    { name: 'custrecordwmaia_shipfrom_address', operator: 'is', values: true }
                ],
                columns: [
                    { name: 'name' },
                    { name: 'custrecordwmaia_address_line1' },
            ...
            res.getElementsByTagName({ tagName: 'member' }).map(function(node) {
                shipments.push({
                    ...
                    ship_from_address: res.getElementsByTagName({ tagName: 'ShipFromAddress' }).length ? {
                        id: '',
                        Name: exports.utils.getTextContentSafe(res.getElementsByTagName({ tagName: 'ShipFromAddress' })[0], 'Name'),
                        AddressLine1: exports.utils.getTextContentSafe(res.getElementsByTagName({ tagName: 'ShipFromAddress' })[0], 'AddressLine1'),
                        AddressLine2: exports.utils.getTextContentSafe(res.getElementsByTagName({ tagName: 'ShipFromAddress' })[0], 'AddressLine2'),
                        City: exports.utils.getTextContentSafe(res.getElementsByTagName({ tagName: 'ShipFromAddress' })[0], 'City'),
                        DistrictOrCounty: exports.utils.getTextContentSafe(res.getElementsByTagName({ tagName: 'ShipFromAddress' })[0], 'DistrictOrCounty'),
                        StateOrProvinceCode: exports.utils.getTextContentSafe(res.getElementsByTagName({ tagName: 'ShipFromAddress' })[0], 'StateOrProvinceCode'),
                        CountryCode: exports.utils.getTextContentSafe(res.getElementsByTagName({ tagName: 'ShipFromAddress' })[0], 'CountryCode'),
                        PostalCode: exports.utils.getTextContentSafe(res.getElementsByTagName({ tagName: 'ShipFromAddress' })[0], 'PostalCode'),
                    } : null,
                    items: []
                });
            });
            if (res.getElementsByTagName({ tagName: 'NextToken' }).length > 0) {
                exports.amazon.listInboundShipments(auth, res.getElementsByTagName({ tagName: 'NextToken' })[0].textContent).map(function(shipment) { return shipments.push(shipment); });
            }
            return shipments;
        },
        listInboundShipmentsItems: function(auth, shipmentId, nextToken) {
            ...
            var content;
            if (nextToken) {
                content = exports.amazon.mwsRequestMaker(auth, 'ListInboundShipmentItemsByNextToken', '2010-10-01', { NextToken: nextToken }, '/FulfillmentInboundShipment/2010-10-01');
            } else {
                content = exports.amazon.mwsRequestMaker(auth, 'ListInboundShipmentItems', '2010-10-01', { ShipmentId: shipmentId }, '/FulfillmentInboundShipment/2010-10-01');
            }
            var res = xml.Parser.fromString({ text: content });
            res.getElementsByTagName({ tagName: 'member' }).map(function(item) {
                items.push({
            ...
            if (res.getElementsByTagName({ tagName: 'NextToken' }).length > 0) {
                exports.amazon.listInboundShipmentsItems(auth, shipmentId, res.getElementsByTagName({ tagName: 'NextToken' })[0].textContent).map(function(item) { return items.push(item); });
            }
            return items;
        },
        createInboundShipmentPlan: function(account_id, address_id, ship_to_country_code, label_prep_preference, items) {
            ...
            if (auth) {
                search.create({
                    ...
                    xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member" }).map(function(_, key) {
                        var plan_items = [];
                        xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:Items/nlapi:member" }).map(function(_, line) {
                            var prepDetailsList = [];
                            xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:Items/nlapi:member[" + (line + 1) + "]/nlapi:PrepDetailsList" }).map(function(_, d) {
                                prepDetailsList.push({
                                    PrepInstruction: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:Items/nlapi:member[" + (line + 1) + "]/nlapi:PrepDetailsList/nlapi:PrepDetails[" + (d + 1) + "]/nlapi:PrepInstruction" })[0].textContent,
                                    PrepOwner: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:Items/nlapi:member[" + (line + 1) + "]/nlapi:PrepDetailsList/nlapi:PrepDetails[" + (d + 1) + "]/nlapi:PrepOwner" })[0].textContent,
                                });
                            });
                            plan_items.push({
                                FulfillmentNetworkSKU: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:Items/nlapi:member[" + (line + 1) + "]/nlapi:FulfillmentNetworkSKU" })[0].textContent,
                                Quantity: Number(xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:Items/nlapi:member[" + (line + 1) + "]/nlapi:Quantity" })[0].textContent),
                                SellerSKU: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:Items/nlapi:member[" + (line + 1) + "]/nlapi:SellerSKU" })[0].textContent,
                                PrepDetailsList: prepDetailsList
                            });
                        });
                        inboundShipmentPlans.push({
                            ShipmentId: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipmentId" })[0].textContent,
                            DestinationFulfillmentCenterId: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:DestinationFulfillmentCenterId" })[0].textContent,
                            ShipToAddress: {
                                id: '',
                                Name: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:Name" }).length ? xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:Name" })[0].textContent : '',
                                AddressLine1: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:AddressLine1" }).length ? xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:AddressLine1" })[0].textContent : '',
                                AddressLine2: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:AddressLine2" }).length ? xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:AddressLine2" })[0].textContent : '',
                                City: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:City" }).length ? xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:City" })[0].textContent : '',
                                DistrictOrCounty: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:DistrictOrCounty" }).length ? xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:DistrictOrCounty" })[0].textContent : '',
                                StateOrProvinceCode: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:StateOrProvinceCode" }).length ? xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:StateOrProvinceCode" })[0].textContent : '',
                                CountryCode: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:CountryCode" }).length ? xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:CountryCode" })[0].textContent : '',
                                PostalCode: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:PostalCode" }).length ? xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:ShipToAddress/nlapi:PostalCode" })[0].textContent : '',
                            },
                            LabelPrepType: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:LabelPrepType" }).length ? xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:LabelPrepType" })[0].textContent : '',
                            Items: plan_items,
                            EstimatedBoxContentsFee: {
                                TotalUnits: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:EstimatedBoxContentsFee/nlapi:TotalUnits" }).length ? Number(xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:EstimatedBoxContentsFee/nlapi:TotalUnits" })[0].textContent) : 0,
                                FeePerUnit: {
                                    CurrencyCode: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:EstimatedBoxContentsFee/nlapi:FeePerUnit/nlapi:CurrencyCode" }).length ? xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:EstimatedBoxContentsFee/nlapi:FeePerUnit/nlapi:CurrencyCode" })[0].textContent : '',
                                    Value: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:EstimatedBoxContentsFee/nlapi:FeePerUnit/nlapi:Value" }).length ? Number(xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:EstimatedBoxContentsFee/nlapi:FeePerUnit/nlapi:Value" })[0].textContent) : 0,
                                },
                                TotalFee: {
                                    CurrencyCode: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:EstimatedBoxContentsFee/nlapi:TotalFee/nlapi:CurrencyCode" }).length ? xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:EstimatedBoxContentsFee/nlapi:TotalFee/nlapi:CurrencyCode" })[0].textContent : '',
                                    Value: xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:EstimatedBoxContentsFee/nlapi:TotalFee/nlapi:Value" }).length ? Number(xml.XPath.select({ node: res, xpath: "//nlapi:InboundShipmentPlans/nlapi:member[" + (key + 1) + "]/nlapi:EstimatedBoxContentsFee/nlapi:TotalFee/nlapi:Value" })[0].textContent) : 0,
                                }
                            }
                        });
                    });
        ...
        createShipmentPlan: function(context) {
            var assistant = ui.createAssistant({ title: 'Create FBA Shipments Assistant' });
            var step_0 = assistant.addStep({ id: 'step_0', label: '??????? PLAN' });
            step_0.helpText = '????????????`1?1?7?1?7';
            var step_1 = assistant.addStep({ id: 'step_1', label: '??????? SHIPMENTS' });
            step_1.helpText = '????????????`1?1?7?1?7';
            var step_2 = assistant.addStep({ id: 'step_2', label: '??????1?7' });
            step_2.helpText = '???????????1?7';
            ...
            if (context.request.method == 'GET') {
                if (!assistant.isFinished()) {
                    ...
                    if (step == 'step_0') {
                        var f00_1 = assistant.addField({ id: 'custpage_f00', label: '???????', type: ui.FieldType.SELECT });
                        exports.amazon.listAccount().map(function(account) {
                            f00_1.addSelectOption({ text: account.abbr + " - " + account.name, value: account.id });
                        });
                        f00_1.setHelpText({ help: 'Please select the Amazon account.', showInlineForAssistant: true });
                        f00_1.isMandatory = true;
                        var f01_1 = assistant.addField({ id: 'custpage_f01', label: '???????', type: ui.FieldType.SELECT });
                        exports.amazon.listInboundAddress().map(function(addr) {
                            f01_1.addSelectOption({ text: addr.Name + " - " + addr.City + " - " + addr.StateOrProvinceCode + " - " + addr.CountryCode, value: addr.id });
                        });
                        f01_1.setHelpText({ help: 'The address from which you will send your inbound shipment.', showInlineForAssistant: true });
                        f01_1.isMandatory = true;
                        var f02 = assistant.addField({ id: 'custpage_f02', label: '????1?1?7?1?7', type: ui.FieldType.SELECT });
                        for (var country in exports.amazon.shipToCountryCode) {
                            f02.addSelectOption({ text: country, value: exports.amazon.shipToCountryCode[country] });
                        }
                        f02.setHelpText({ help: 'The two-character country code for the country where you want your inbound shipment to be sent.', showInlineForAssistant: true });
                        f02.isMandatory = true;
                        var f03_1 = assistant.addField({ id: 'custpage_f03', label: 'LabelPrepPreference', type: ui.FieldType.SELECT });
                        exports.amazon.labelPrepPreference.map(function(type) { return f03_1.addSelectOption({ text: type, value: type }); });
                        f03_1.setHelpText({ help: 'Your preference for label preparation for an inbound shipment.', showInlineForAssistant: true }).isMandatory = true;
                        /** ??????????1?1?7?1?7??1?1?7?1?7 */
                        var f05_1 = assistant.addField({ id: 'custpage_f05', label: 'Shipment Plan Importer Record', type: ui.FieldType.SELECT });
                        f05_1.addSelectOption({ text: '', value: '' });
                        search.create({ type: fiedls.amazon_inbound_item._name, columns: [{ name: fiedls.amazon_inbound_item.inbound_reference, summary: search.Summary.GROUP }] }).run().each(function(rec) {
                            f05_1.addSelectOption({ text: rec.getValue(rec.columns[0]), value: rec.getValue(rec.columns[0]) });
                            return true;
                        });
                        f05_1.setHelpText({ help: 'The Amazon Standard Identification Number (ASIN) of the item By File Upload.', showInlineForAssistant: true });
                        /** ???????????1?7 */
                        var f04 = assistant.addSublist({ id: 'custpage_f04', label: '????????1?7?1?7?1?7', type: ui.SublistType.INLINEEDITOR });
                        var f0401 = f04.addField({ id: 'custpage_f0401', label: 'SellerSKU', type: ui.FieldType.SELECT, source: 'item' }).setHelpText({ help: 'The Seller SKU of the item.', showInlineForAssistant: true });
                        f0401.updateDisplayType({ displayType: ui.FieldDisplayType.ENTRY });
                        f0401.isMandatory = true;
                        f04.addField({ id: 'custpage_f0402', label: 'ASIN', type: ui.FieldType.TEXT })
                            .setHelpText({ help: 'The Amazon Standard Identification Number (ASIN) of the item.', showInlineForAssistant: true })
                            // .updateDisplayType({displayType: ui.FieldDisplayType.INLINE})
                            .isMandatory = false;
                        var f0403_1 = f04.addField({ id: 'custpage_f0403', label: 'Condition', type: ui.FieldType.SELECT }).setHelpText({ help: 'The condition of the item.', showInlineForAssistant: true });
                        exports.amazon.condition.map(function(c) { return f0403_1.addSelectOption({ text: c, value: c }); });
                        f0403_1.isMandatory = false;
                        f04.addField({ id: 'custpage_f0404', label: 'Quantity', type: ui.FieldType.INTEGER }).setHelpText({ help: 'The item quantity.', showInlineForAssistant: true }).isMandatory = true;
                        f04.addField({ id: 'custpage_f0405', label: 'QuantityInCase', type: ui.FieldType.INTEGER }).setHelpText({ help: 'If QuantityInCase is specified, its value must be a divisor of Quantity.', showInlineForAssistant: true }).isMandatory = false;
                        ...
                        f04.updateUniqueFieldId({ id: 'custpage_f0401' });
                        f04.updateTotallingFieldId({ id: 'custpage_f0404' });
                    } else if (step == 'step_1') {
                        // assistant.setSplash({
                        //     title: "??????????1?1?7?1?7?1?7?1?7?1?7???????1?7?1?7?1?7",
                        //     text1: "?????????????????????????????Shipment????",
                        //     text2: "???????????shipment???."
                        // });
                        var account_id = Number(step_0.getValue({ id: 'custpage_f00' }));
                        var address_id = Number(step_0.getValue({ id: 'custpage_f01' }));
                        var ship_to_country = step_0.getValue({ id: 'custpage_f02' });
                        var label_prep_preference = step_0.getValue({ id: 'custpage_f03' });
                        var items_1 = [];
                        var items_count = step_0.getLineCount({ group: 'custpage_f04' });
                        var _loop_1 = function(line) {
                            var item_id = step_0.getSublistValue({ group: 'custpage_f04', id: 'custpage_f0401', line: line });
                            if (!item_id) {
                                assistant.errorHtml = "\u63D0\u4EA4\u6570\u636E\u5F02\u5E38\uFF0C\u8BF7\u8FD4\u56DE\u4E0A\u4E00\u6B65\u91CD\u65B0\u64CD\u4F5C\uFF01";
                                context.response.writePage({ pageObject: assistant });
                                return { value: void 0 };
                            }
                            search.create({ type: 'item', filters: [{ name: 'internalid', operator: 'is', values: item_id }], columns: [{ name: 'itemid' }] }).run().each(function(rec) {
                                items_1.push({
                                    'SellerSKU': rec.getValue(rec.columns[0]),
                                    'ASIN': step_0.getSublistValue({ group: 'custpage_f04', id: 'custpage_f0402', line: line }),
                                    'Condition': step_0.getSublistValue({ group: 'custpage_f04', id: 'custpage_f0403', line: line }),
                                    'Quantity': step_0.getSublistValue({ group: 'custpage_f04', id: 'custpage_f0404', line: line }),
                                    'QuantityInCase': step_0.getSublistValue({ group: 'custpage_f04', id: 'custpage_f0405', line: line }),
                                });
                                return false;
                            });
                        };
                        ...
                        try {
                            ...
                            var fsource = assistant.addField({ id: _step_prefix_1 + "f_source", label: 'source data', type: ui.FieldType.TEXTAREA });
                            fsource.updateDisplayType({ displayType: ui.FieldDisplayType.HIDDEN });
                            ...
                            inboundShipmentPlans_1.map(function(plan, i) {
                                ...
                                assistant.addFieldGroup({ id: _container_id, label: "\u8BBE\u7F6E" + plan.ShipmentId + "\u7684\u8BE6\u7EC6\u4FE1\u606F (" + (i + 1) + " / " + inboundShipmentPlans_1.length + ")" }).isSingleColumn = false;
                                var fshipment_name = assistant.addField({ id: "" + _step_prefix_1 + i + "f_shipment_name", label: 'Shipment Name', type: ui.FieldType.TEXT, container: _container_id });
                                fshipment_name.isMandatory = true;
                                var fshipment_status = assistant.addField({ id: "" + _step_prefix_1 + i + "f_shipment_status", label: 'Shipment Status', type: ui.FieldType.SELECT, container: _container_id });
                                ['', 'WORKING', 'SHIPPED'].map(function(s) { return fshipment_status.addSelectOption({ text: s, value: s }); });
                                fshipment_status.isMandatory = true;
                                var fshipment_ibcs = assistant.addField({ id: "" + _step_prefix_1 + i + "f_shipment_ibcs", label: 'intended Box Contents Source', type: ui.FieldType.SELECT, container: _container_id });
                                exports.amazon.intendedBoxContentsSource.map(function(_) { return fshipment_ibcs.addSelectOption({ text: _, value: _ }); });
                                fshipment_ibcs.isMandatory = true;
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f_shipment_are_cases_required", label: 'Are Cases Required', type: ui.FieldType.CHECKBOX, container: _container_id });
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f01", label: 'Shipment Id', type: ui.FieldType.TEXT, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = plan.ShipmentId;
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f02", label: 'Destination Fulfillment CenterId', type: ui.FieldType.TEXT, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = plan.DestinationFulfillmentCenterId;
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f03", label: 'Label Prep Type', type: ui.FieldType.TEXT, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = plan.LabelPrepType;
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f05", label: 'Total Units', type: ui.FieldType.INTEGER, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = String(plan.EstimatedBoxContentsFee.TotalUnits);
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f06", label: 'Fee Per Unit', type: ui.FieldType.CURRENCY, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = String(plan.EstimatedBoxContentsFee.FeePerUnit.Value);
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f07", label: 'Total Fee', type: ui.FieldType.CURRENCY, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).updateBreakType({ breakType: ui.FieldBreakType.STARTCOL }).defaultValue = String(plan.EstimatedBoxContentsFee.TotalFee.Value);
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f08", label: 'Name', type: ui.FieldType.TEXT, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = String(plan.ShipToAddress.Name);
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f09", label: 'Address Line 1', type: ui.FieldType.TEXT, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = String(plan.ShipToAddress.AddressLine1);
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f10", label: 'Address Line 2', type: ui.FieldType.TEXT, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = String(plan.ShipToAddress.AddressLine2);
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f11", label: 'City', type: ui.FieldType.TEXT, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = String(plan.ShipToAddress.City);
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f12", label: 'District Or County', type: ui.FieldType.TEXT, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = String(plan.ShipToAddress.DistrictOrCounty);
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f13", label: 'State Or Province Code', type: ui.FieldType.TEXT, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = String(plan.ShipToAddress.StateOrProvinceCode);
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f14", label: 'Country Code', type: ui.FieldType.TEXT, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = String(plan.ShipToAddress.CountryCode);
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f15", label: 'Postal Code', type: ui.FieldType.TEXT, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE }).defaultValue = String(plan.ShipToAddress.PostalCode);
                                assistant.addField({ id: "" + _step_prefix_1 + i + "f16", label: 'Items', type: ui.FieldType.TEXTAREA, container: _container_id }).updateDisplayType({ displayType: ui.FieldDisplayType.INLINE })
                        ...
                        var results_1 = [];
                        var source = JSON.parse(step_1.getValue({ id: 'custpage_s1f_source' }));
                        if (!source) {
                            assistant.errorHtml = "\u63D0\u4EA4\u6570\u636E\u5F02\u5E38\uFF0C\u8BF7\u8FD4\u56DE\u4E0A\u4E00\u6B65\u91CD\u65B0\u64CD\u4F5C\uFF01";
                            context.response.writePage({ pageObject: assistant });
                            return;
                        }
                        var account_id_1 = Number(step_0.getValue({ id: 'custpage_f00' }));
                        var address_id_1 = Number(step_0.getValue({ id: 'custpage_f01' }));
                        var ship_to_country = step_0.getValue({ id: 'custpage_f02' });
                        var label_prep_preference_1 = step_0.getValue({ id: 'custpage_f03' });
                        var plan = record.create({ type: 'customrecord_aio_amazon_plan', isDynamic: true });
                        var acc_1 = record.load({ type: 'customrecord_aio_account', id: account_id_1 });
                        plan.setValue({ fieldId: 'name', value: source.map(function(_) { return _.ShipmentId; }).join('/') });
                        plan.setValue({ fieldId: 'custrecord_aio_plan_account', value: account_id_1 });
                        plan.setValue({ fieldId: 'custrecord_aio_plan_from', value: address_id_1 });
                        plan.setValue({ fieldId: 'custrecord_aio_plan_country', value: ship_to_country });
                        plan.setText({ fieldId: 'custrecord_aio_plan_label', text: label_prep_preference_1 });
                        plan.setValue({ fieldId: 'custrecord_aio_plan_items', value: step_1.getValue({ id: 'custpage_s1f_source' }) });
                        var pid_1 = plan.save();
                        try {
                            source.map(function(_, key) {
                                ...
                                var shipment_id = exports.amazon.createInboundShipment(account_id_1, address_id_1, _.ShipmentId, "" + step_1.getValue({ id: "custpage_s1" + key + "f_shipment_name" }), _.DestinationFulfillmentCenterId, "" + step_1.getValue({ id: "custpage_s1" + key + "f_shipment_status" }), "" + step_1.getValue({ id: "custpage_s1" + key + "f_shipment_ibcs" }), _.LabelPrepType, items);
                                /* ????TO */
                                var to = record.create({ type: 'transferorder', isDynamic: true });
                                to.setValue({ fieldId: 'customform', value: acc_1.getValue(fiedls.account.to_form) });
                                to.setValue({ fieldId: 'externalid', value: "aio" + account_id_1 + "." + _.ShipmentId });
                                to.setValue({ fieldId: 'memo', value: "" + _.ShipmentId });
                                if (exports.utils.checkIfSubsidiaryEnabled()) {
                                    to.setValue({ fieldId: 'subsidiary', value: acc_1.getValue('custrecord_aio_subsidiary') });
                                    log.audit('TO set Subsidiary', acc_1.getValue('custrecord_aio_subsidiary'));
                                }
                                to.setValue({ fieldId: 'location', value: acc_1.getValue('custrecord_aio_to_default_from_location') });
                                to.setValue({ fieldId: 'transferlocation', value: acc_1.getValue('custrecord_aio_fbaorder_location') });
                                to.setValue({ fieldId: 'department', value: acc_1.getValue('custrecord_aio_dept') });
                                to.setValue({ fieldId: 'firmed', value: true });
                                to.setValue({ fieldId: 'incoterm', value: 1 });
                                to.setValue({ fieldId: 'tranid', value: "AIO" + _.ShipmentId });
                                to.setValue({ fieldId: 'custbody_aio_account', value: account_id_1 });
                                to.setValue({ fieldId: 'custbody_aio_marketplaceid', value: 1 /* amazon */ });
                                to.setValue({ fieldId: 'custbody_aio_inbound_shipment_id', value: "" + _.ShipmentId });
                                to.setValue({ fieldId: 'custbody_aio_inbound_shipment_name', value: "" + step_1.getValue({ id: "custpage_s1" + key + "f_shipment_name" }) });
                                to.setValue({ fieldId: 'custbody_aio_inbound_dest_center_id', value: "" + _.DestinationFulfillmentCenterId });
                                to.setValue({ fieldId: 'custbody_aio_inbound_label_prep_type', value: "" + label_prep_preference_1 });
                                to.setValue({ fieldId: 'custbody_aio_inbound_shipment_status', value: "" + step_1.getValue({ id: "custpage_s1" + key + "f_shipment_status" }) });
                                to.setValue({ fieldId: 'custbody_aio_inbound_case_required', value: "" + (step_1.getValue({ id: "custpage_s1" + key + "f_shipment_are_cases_required" }) || '') });
                                to.setValue({ fieldId: 'custbody_aio_inbound_ship_from_addr', value: address_id_1 });
                                var addrtoid;
                                search.create({
                                    type: 'customrecord_aio_amazon_inbound_address',
                                    filters: [
                                        { name: 'custrecordcenterid', operator: 'is', values: _.DestinationFulfillmentCenterId },
                                        { name: 'custrecordwmaia_shipfrom_address', operator: 'is', values: false }
                                    ]
                                ...
                                if (!addrtoid) {
                                    ...
                                    var addrto = record.create({ type: 'customrecord_aio_amazon_inbound_address', isDynamic: true });
                                    addrto.setValue({ fieldId: 'custrecordwmaia_shipfrom_address', value: false });
                                    addrto.setValue({ fieldId: 'name', value: step_1.getValue({ id: "custpage_s1" + key + "f08" }) + ", " + step_1.getValue({ id: "custpage_s1" + key + "f09" }) });
                                    addrto.setValue({ fieldId: 'custrecordcenterid', value: _.DestinationFulfillmentCenterId });
                                    addrto.setValue({ fieldId: 'custrecord_name', value: "" + (step_1.getValue({ id: "custpage_s1" + key + "f08" }) || '') });
                                    addrto.setValue({ fieldId: 'custrecordwmaia_address_line1', value: "" + (step_1.getValue({ id: "custpage_s1" + key + "f09" }) || '') });
                                    addrto.setValue({ fieldId: 'custrecordwmaia_address_line2', value: "" + (step_1.getValue({ id: "custpage_s1" + key + "f10" }) || '') });
                                    addrto.setValue({ fieldId: 'custrecordwmaia_city', value: "" + (step_1.getValue({ id: "custpage_s1" + key + "f11" }) || '') });
                                    addrto.setValue({ fieldId: 'custrecordwmaia_district_or_country', value: "" + (step_1.getValue({ id: "custpage_s1" + key + "f12" }) || '') });
                                    addrto.setValue({ fieldId: 'custrecordwmaia_state_or_province_code', value: "" + (step_1.getValue({ id: "custpage_s1" + key + "f13" }) || '') });
                                    addrto.setValue({ fieldId: 'custrecordwmaia_country_code', value: "" + (step_1.getValue({ id: "custpage_s1" + key + "f14" }) || '') });
                                    addrto.setValue({ fieldId: 'custrecordwmaia_postal_code', value: "" + (step_1.getValue({ id: "custpage_s1" + key + "f15" }) || '') });
                                    addrtoid = addrto.save();
                                }
                                to.setValue({ fieldId: 'custbody_aio_inbound_ship_to_addr', value: addrtoid });
                                results_1.push("ShipmentId: " + _.ShipmentId);
                                results_1.push("InboundShipmentHeader:");
                                results_1.push("-ShipmentName: " + step_1.getValue({ id: "custpage_s1" + key + "f_shipment_name" }));
                                results_1.push("-ShipFromAddress(id): " + step_0.getValue({ id: 'custpage_f01' }));
                                ...
                                results_1.push("-Are Case Required: " + step_1.getValue({ id: "custpage_s1" + key + "f_shipment_are_cases_required" }));
                                results_1.push("-Shipment Status: " + step_1.getValue({ id: "custpage_s1" + key + "f_shipment_status" }));
                                ...
                                _.Items.map(function(item) {
                                    search.create({ type: 'item', filters: [{ name: 'itemid', operator: 'is', values: "" + item.SellerSKU }], columns: [{ name: 'type' }, { name: 'itemid' }] }).run().each(function(t) {
                                        var type = t.getValue(t.columns[0]);
                                        var item_name = t.getValue(t.columns[1]);
                                        if (type == 'Kit') {
                                            var i = record.load({ type: 'kititem', id: t.id });
                                            for (var index = 0; index < i.getLineCount({ sublistId: 'member' }); index++) {
                                                ...
                                                to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'quantity', value: "" + item.Quantity * item_qty });
                                                to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'quantityreceived', value: 0 });
                                                // ???????U1?1?7?1?7
                                                to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_aio_shipment_id', value: "" + _.ShipmentId });
                                                to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_aio_amazon_msku', value: "" + item_name });
                                                to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_aio_fnsku', value: "" + item.FulfillmentNetworkSKU });
                                                to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_aio_qty_shipped', value: "" + item.Quantity * item_qty });
                                                to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_aio_qty_received', value: 0 });
                                                to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_aio_qty_in_case', value: "" + (item.QuantityInCase || 1) });
                                                to.commitLine({ sublistId: 'item' });
                                            }
                                        } else {
                                            to.selectNewLine({ sublistId: 'item' });
                                            to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'item', value: t.id });
                                            to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'quantity', value: "" + item.Quantity });
                                            to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'quantityreceived', value: 0 });
                                            // ???????U1?1?7?1?7
                                            to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_aio_shipment_id', value: "" + _.ShipmentId });
                                            to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_aio_amazon_msku', value: "" + item_name });
                                            to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_aio_fnsku', value: "" + item.FulfillmentNetworkSKU });
                                            to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_aio_qty_shipped', value: "" + item.Quantity });
                                            to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_aio_qty_received', value: 0 });
                                            to.setCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_aio_qty_in_case', value: "" + (item.QuantityInCase || 1) });
                                            to.commitLine({ sublistId: 'item' });
                                        }
                                ...
                                _.Items.map(function(item) {
                                    search.create({ type: 'item', filters: [{ name: 'itemid', operator: 'is', values: "" + item.SellerSKU }], columns: [{ name: 'type' }, { name: 'itemid' }] }).run().each(function(t) {
                                        var line = record.create({ type: 'customrecord_aio_amazon_plan_items', isDynamic: true });
                                        line.setValue({ fieldId: 'custrecord_aio_amazon_plan_id', value: pid_1 });
                                        line.setValue({ fieldId: 'custrecord_aio_amazon_plan_item', value: t.id });
                                        line.setValue({ fieldId: 'custrecord_aio_amazon_plan_fnsku', value: "" + item.FulfillmentNetworkSKU });
                                        ...
                                        line.setValue({ fieldId: 'custrecord_aio_amazon_plan_qty', value: "" + item.Quantity });
                                        line.setValue({ fieldId: 'custrecord_aio_amazon_plan_qtyincase', value: "" + (item.QuantityInCase || '') });
                                        line.setValue({ fieldId: 'custrecord_aio_amazon_plan_tran_id', value: tid });
                                        line.setValue({ fieldId: 'custrecord_aio_amazon_plan_shipmentid', value: "" + _.ShipmentId });
                                        line.save();
                                        results_1.push("-ShipmentId: " + _.ShipmentId);
                                        ...
                                        step_1.getValue({ id: "custpage_s1" + key + "f_shipment_are_cases_required" }) ? results_1.push("-Quantity In Case: " + item.QuantityInCase) : null;
                                        return false;
                                    });
                                });
                                results_1.push('');
                            ...
                            record.delete({ type: 'customrecord_aio_amazon_plan', id: pid_1 });
        ...
        createInboundShipment: function(account_id, address_id, shipment_id, shipment_name, destination_fulfillment_center_id, status, intended_box_contents_source, label_prep_preference, items) {
            ...
            if (auth && addr) {
                log.debug("cor createInboundShipment addr",addr)
                return
                var params_3 = {
                ...
                if(addr.AddressLine2){
                    params_3["InboundShipmentHeader.ShipFromAddress.AddressLine2"]=addr.AddressLine2
                }
                items.map(function(item, key) {
                ...
                log.debug('cor response', response);
                var res = xml.Parser.fromString({ text: response });
        ...
        FBAFulfillmentOrder: function(account_id, rows) {
            ...
            rows.map(function(row, _) {
                ...
                var DisplayableOrderDate = format.parse({ type: format.Type.DATE, value: row.DisplayableOrderDateTime });
        ...
        uploadTracking: function(account_id, rows) {
            ...
            rows.map(function(row, _) {
                var iso_dt = format.parse({ type: format.Type.DATE, value: row.tran_date });
                body += "<Message>";
                body += "<MessageID>" + (_ + 1) + "</MessageID>";
        ...
        submitCartonContent: function(account_id, to_id, shipment_id) {
            var auth = exports.amazon.getAuthByAccountId(account_id),
                to = record.load({ type: record.Type.TRANSFER_ORDER, id: to_id, isDynamic: true });
            if (auth) {
                var params = {},
                    carton_infos_1 = {};
                search.create({
                    ...
                    filters: [
                        { name: exports.ns.amazon_shipment_import.amazon_shipment_toid, operator: search.Operator.ANYOF, values: to_id }
                    ],
                    columns: [
                    ...
                    var item_line_no = to.findSublistLineWithValue({ sublistId: 'item', fieldId: 'item', value: b.getValue(b.columns[0]) });
                    if (item_line_no == -1)
                        throw "\u6570\u636E\u975E\u6CD5\uFF0CITEM[" + b.getText(b.columns[0]) + "]\u5728\u521D\u59CB\u5355\u636E\u4E0A\u627E\u4E0D\u5230\uFF01";
                    var boxinfo = {
                        sku: to.getSublistValue({ sublistId: 'item', fieldId: exports.ns.cols.amazon_msku, line: item_line_no }),
                        qty: to.getSublistValue({ sublistId: 'item', fieldId: 'quantity', line: item_line_no }),
                ...
                if (res.getElementsByTagName({ tagName: 'FeedProcessingStatus' }).length > 0) {
                    ...
                    feed.setValue({ fieldId: exports.ns.amazon_feed.started_processing_date, value: exports.utils.getTextContentSafe(res, 'StartedProcessingDate') });
                    feed.setValue({ fieldId: exports.ns.amazon_feed.completed_processing_date, value: exports.utils.getTextContentSafe(res, 'CompletedProcessingDate') });
                    feed.setValue({ fieldId: exports.ns.amazon_feed.feed_body, value: body_1 });
                    feed.setValue({ fieldId: exports.ns.amazon_feed.feed_referenced, value: to_id });
                    // feed.setValue({fieldId: ns.amazon_feed.feed_response, value: res.getElementsByTagName({ tagName: 'FeedSubmissionId' })[0].textContent});
                    feed.save();
                    return res.getElementsByTagName({ tagName: 'FeedProcessingStatus' })[0].textContent;
                } else {
        ...
        putTransportContent: function(account_id, to_id, shipment_id) {
            ...
            if (auth) {
                ...
                var transport_content = exports.amazon.mwsRequestMaker(auth, 'PutTransportContent', '2010-10-01', pms_1, '/FulfillmentInboundShipment/2010-10-01'),
                    transport_result = xml.Parser.fromString({ text: transport_content });
                if (transport_result.getElementsByTagName({ tagName: 'TransportStatus' }).length > 0 && transport_result.getElementsByTagName({ tagName: 'TransportStatus' })[0].textContent == 'WORKING') {
                    return 'WORKING';
                } else {
        ...
        updateInboundShipment: function(account_id, to_id, shipment_id, shipment_status) {
            ...
            if (auth && addr) {
                ...
                var line_count = to.getLineCount({ sublistId: 'item' });
                for (var key = 0; key < line_count; key++) {
                    params["InboundShipmentItems.member." + (key + 1) + ".QuantityShipped"] = to.getSublistValue({ sublistId: 'item', fieldId: exports.ns.cols.qty_shipped, line: key });
                    params["InboundShipmentItems.member." + (key + 1) + ".SellerSKU"] = to.getSublistValue({ sublistId: 'item', fieldId: exports.ns.cols.amazon_msku, line: key });
                }
                log.debug('params', params);
                ...
                if (rtn_shipment_id) {
                    to.setValue({ fieldId: exports.ns.bodies.inbound_shipment_status, value: exports.amazon.listInboundShipments(auth, null, [rtn_shipment_id]).shift().shipment_status });
                    to.save();
                    return rtn_shipment_id;
                } else {
            ...
            if (auth) {
                var key_1 = 0,
                    s = search.create({
                        ...
                        columns: [
                            { name: exports.ns.amazon_shipment_import.amazon_shipment_boxid, summary: search.Summary.GROUP }
                        ]
                    }).run();
                if (page) {
                    s.getRange({ start: (page - 1) * 50, end: page * 50 }).map(function(rec) {
        ...
        mwsRequestMaker: function(auth, action, version, params, resource, body) {
            ...
            if (response.body.indexOf('</ErrorResponse>') != -1) {
                var err = xml.Parser.fromString({ text: response.body });
                if (err) {
                    /** MWS??????????????1?7?1?7?1?7?1?7?1?7?1?7?1?7?1?7 */
                    email.send({
                        author: -5,
        ...
        shipToCountryCode: { 'United States': 'US', 'Canada': 'CA', 'Mexico': 'MX', 'Germany': 'DE', 'Spain': 'ES', 'France': 'FR', 'United Kingdom': 'GB', 'Italy': 'IT', 'Japan': 'JP' },
    ...
    exports.ebay = {
        ...
        fields: ['custrecord_aio_eb_logo', /** 'custrecord_aio_eb_enable_tracking_upload', */ 'custrecord_aio_eb_global_site_access', 'custrecord_aio_ebay_access_token', 'custrecord_aio_eb_registered_county', 'custrecord_aio_eb_dev_account', 'custrecord_aio_ebay_sellerid', 'custrecord_aio_ebay_token_expiration'],
        geteBayAccountList: function() {
            var list = [];
            search.create({
                type: 'customrecord_aio_account',
                filters: [
                    { name: 'custrecord_aio_marketplace', operator: 'anyof', values: 2 /* ebay */ },
                    { name: 'custrecord_aio_ebay_token_expiration', operator: 'isnotempty' },
                    { name: 'custrecord_aio_eb_dev_account', operator: 'noneof', values: '@NONE@' },
                    { name: 'isinactive', operator: 'is', values: false },
                ],
                columns: [
                    { name: 'custrecord_aio_ebay_access_token' },
                    { name: 'custrecord_aio_eb_dev_name', join: 'custrecord_aio_eb_dev_account' },
                    { name: 'custrecord_aio_eb_app_name', join: 'custrecord_aio_eb_dev_account' },
                    { name: 'custrecord_aio_ebay_cert_name', join: 'custrecord_aio_eb_dev_account' },
                    { name: 'custrecord_aio_eb_site_id', join: 'custrecord_aio_eb_global_site_access' },
                    { name: 'name' },
                    ...
                    { name: 'custrecord_aio_salesorder_payment_method' },
                    { name: 'custrecord_aio_discount_item' },
                    { name: 'custrecord_aio_eb_site_default_currency', join: 'custrecord_aio_eb_global_site_access' },
                    exports.utils.checkIfSubsidiaryEnabled() ? { name: 'custrecord_aio_subsidiary' } : { name: 'formulanumeric', formula: '0' },
                    { name: fiedls.account.if_post_order_fulfillment },
                    { name: 'custrecord_aio_tax_item' },
                    /** @index 19 */
                    { name: fiedls.account.post_order_if_search },
                    { name: 'custrecord_aio_ebay_runame', join: 'custrecord_aio_eb_dev_account' },
                    { name: 'custrecord_aio_ebay_session_id' },
                    { name: 'custrecord_aio_ebay_refresh_token' },
                    { name: 'custrecord_aio_ebay_paypal_username' },
                    { name: 'custrecord_aio_ebay_paypal_password' },
                    { name: 'custrecord_aio_ebay_paypal_signature' },
                ]
            }).run().each(function(rec) {
                list.push({
                    id: rec.id,
                    auth_meta: {
                        ...
                        username: rec.getValue(rec.columns[23]),
                        password: rec.getValue(rec.columns[24]),
                        signature: rec.getValue(rec.columns[25])
                    },
                    site_id: rec.getValue(rec.columns[4]),
                    info: {
        ...
        getAuthByAccountId: function(account_id) {
            ...
            search.create({
                ...
                columns: [
                    { name: 'custrecord_aio_ebay_access_token' },
                    { name: t2.eb_dev_name, join: t.eb_dev_account },
                    { name: t2.eb_app_name, join: t.eb_dev_account },
                    { name: t2.ebay_cert_name, join: t.eb_dev_account },
                    { name: t3.eb_site_id, join: t.eb_global_site_access },
                    { name: 'custrecord_aio_ebay_runame', join: t.eb_dev_account },
                    { name: 'custrecord_aio_ebay_session_id' },
                    { name: 'custrecord_aio_ebay_refresh_token' },
                ]
            }).run().each(function(rec) {
        ...
        //=====================yuan  error reason=============
        geteBayRecentOrders: function(account, ids) {
//
            var body = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n        <GetOrdersRequest xmlns=\"urn:ebay:apis:eBLBaseComponents\">\n        <RequesterCredentials>\n            <eBayAuthToken>" + account.auth_meta.token + "</eBayAuthToken>\n        </RequesterCredentials>\n        <ErrorLanguage>zh_CN</ErrorLanguage>\n        <Version>989</Version>\n        <WarningLevel>Low</WarningLevel>\n        <ModTimeFrom>" + moment.utc().subtract(4, 'hours').startOf('hour').toISOString() + "</ModTimeFrom>\n        <ModTimeTo>" + moment.utc().subtract(1, 'hours').endOf('hour').toISOString() + "</ModTimeTo>\n        " + (ids && ids.length ? "<OrderIDArray>" + ids.map(function(id) { return "<OrderID>" + id + "</OrderID>"; }).join('') + "</OrderIDArray>" : '') + "\n        <OrderStatus>Completed</OrderStatus>\n        <DetailLevel>ReturnAll</DetailLevel>\n        <OrderRole>Seller</OrderRole>\n        <Pagination><EntriesPerPage>200</EntriesPerPage><PageNumber>1</PageNumber></Pagination>\n        </GetOrdersRequest>";
            var res = xml.Parser.fromString({ text: exports.ebay.eBayRequestMaker(account.auth_meta, 'GetOrders', body) });
...
//            var pathvalue = function(xpath, line) { return (xml.XPath.select({ node: res, xpath: "//nlapi:OrderArray//nlapi:Order[" + line + "]" + xpath }) && xml.XPath.select({ node: res, xpath: "//nlapi:OrderArray//nlapi:Order[" + line + "]" + xpath }).length) ? xml.XPath.select({ node: res, xpath: "//nlapi:OrderArray//nlapi:Order[" + line + "]" + xpath })[0].textContent : ''; };
            var pathvalue = function(xpath, line) {
            	...
            	return (xml.XPath.select({ node: res, xpath: "//nlapi:OrderArray//nlapi:Order[" + line + "]" + xpath }) && xml.XPath.select({ node: res, xpath: "//nlapi:OrderArray//nlapi:Order[" + line + "]" + xpath }).length) ? xml.XPath.select({ node: res, xpath: "//nlapi:OrderArray//nlapi:Order[" + line + "]" + xpath })[0].textContent : ''; 
            	};
                //================================== end ===========================================//
            var order_nums = parseInt(res.getElementsByTagName({ tagName: 'ReturnedOrderCountActual' })[0].textContent);
            var orders = [];
            res.getElementsByTagName({ tagName: 'Order' }).map(function(order, index) {
                var line = "" + (index + 1);
                var customer = {
                ...
                var items = [];
                xml.XPath.select({ node: res, xpath: "//nlapi:OrderArray//nlapi:Order[" + line + "]//nlapi:TransactionArray//nlapi:Transaction" }).map(function(node, index) {
                    items.push({
            ...
            if (auth) {
                rows.map(function(row) {
                    var body = [
                        ...
                        res = xml.Parser.fromString({ text: response }),
                    ...
                    feeds.push(file.create({ name: row.account_id + "-" + row.tran_id + "-request.xml", fileType: file.Type.XMLDOC, contents: body }));
                    feeds.push(file.create({ name: row.account_id + "-" + row.tran_id + "-response.xml", fileType: file.Type.XMLDOC, contents: response }));
                });
            } else {
                throw "\u83B7\u53D6eBay\u767B\u5F55\u4FE1\u606F\u5931\u8D25\uFF01";
            }
            /** ???1?7?1?7?1?7?1?7?1?7?1?7????1?1?7?1?7 */
            email.send({
        ...
        eBayRequestMaker: function(auth, action, xml) {
            ...
            log.debug('eBayRequestMaker respone', respone);
            return respone.body;
        },
        /** ????@1?1?7?1?7 */
        ...
        get_acc_by_uname: function(name) {
            ...
            search.create({
                ...
                filters: [
                    { name: 'custrecord_aio_ebay_sellerid', operator: search.Operator.IS, values: name }
                ]
            }).run().each(function(rec) {
        ...
        gen_sign_in_link: function(acc_id) {
            var acc = exports.ebay.getAuthByAccountId(acc_id),
                ...
                res = xml.Parser.fromString({ text: response });
            if (res.getElementsByTagName({ tagName: 'SessionID' }).length) {
                var sessionid = res.getElementsByTagName({ tagName: 'SessionID' })[0].textContent;
                record.submitFields({ type: exports.ns.account._name, id: acc_id, values: { 'custrecord_aio_ebay_session_id': sessionid } });
        ...
        fetch_token: function(username) {
            ...
            if (res.getElementsByTagName({ tagName: 'eBayAuthToken' }).length) {
                var token = res.getElementsByTagName({ tagName: 'eBayAuthToken' })[0].textContent,
                    expiration_time = res.getElementsByTagName({ tagName: 'HardExpirationTime' })[0].textContent;
                record.submitFields({
                    type: exports.ns.account._name,
                    id: acc.id,
                    values: {
            ...
            var acc = exports.ebay.getAuthByAccountId(acc_id),
                response = https.post({
                    ...
                    headers: {
                        ...
                        'Authorization': "Basic " + encode.convert({ string: acc.app_id + ":" + acc.app_cert, inputEncoding: encode.Encoding.UTF_8, outputEncoding: encode.Encoding.BASE_64 }),
                    },
                    body: [
    ...
    exports.paypal = {
        _endpoint: 'https://api.paypal.com/v1',
        _client_id: 'AUsLYM6X0uyHBG0oGzQwvsA90QJL3b0yGEynhRod-z848jaYriMfjfjriX9nV7Yrj-TOFba_Pq92Pq2x',
        _client_secret: 'EBhYExZ8GUZ8Xi2zjcWkF36tdP-ewLxV_dHjiE1Lbo8jRh4EECSitvw1PBtx_FRcpWcYTHWK1AxBCcz3',
        gettoken: function() {
            var c = cache.getCache({ name: PAYPAL_TOKEN_CACHE });
            return c.get({ key: 'access_token', loader: exports.paypal.token });
        },
        token: function() {
            var c = cache.getCache({ name: PAYPAL_TOKEN_CACHE }),
                rtn = https.request({
                    url: exports.paypal._endpoint + "/oauth2/token",
                    method: https.Method.POST,
                    headers: {
                        'Accept': 'application/json',
                        'Accept-Language': 'en_US',
                        'Content-Type': 'application/x-www-form-urlencoded',
                        'Authorization': "Basic " + encode.convert({ inputEncoding: encode.Encoding.UTF_8, outputEncoding: encode.Encoding.BASE_64_URL_SAFE, string: exports.paypal._client_id + ":" + exports.paypal._client_secret })
                    },
            ...
            if (res && res.access_token && res.access_token.length > 0) {
                ...
                throw "Can not Issue Paypal Token: " + rtn;
            }
        },
        getTransactionDetails0: function(order_id) {
            return https.get({
                url: exports.paypal._endpoint + "/checkout/orders/" + order_id,
                headers: {
                    'Accept': 'application/json',
                    'Accept-Language': 'en_US',
                    'Content-Type': 'application/json',
                    'Authorization': "Bearer " + exports.paypal.gettoken()
                }
            });
        },
        getTransactionDetails: function(tran_id, apiUsername, apiPassword, apiSignature) {
    ...
    exports.walmart = {
        ...
        getWalmartAccountList: function() {
            ...
            search.create({
                type: 'customrecord_aio_account',
                filters: [
                    { name: 'custrecord_aio_marketplace', operator: 'anyof', values: 7 /* walmart */ },
                    { name: 'custrecord_aio_warmart_dev_account', operator: 'noneof', values: '@NONE@' },
                    { name: 'isinactive', operator: 'is', values: false },
                ],
                columns: [
                    { name: 'custrecord_aio_walmart_consumer_id', join: 'custrecord_aio_warmart_dev_account' },
                    { name: 'custrecord_aio_walmart_private_id', join: 'custrecord_aio_warmart_dev_account' },
                    { name: 'custrecord_aio_walmart_api_header', join: 'custrecord_aio_warmart_dev_account' },
                    { name: 'name' },
                    { name: 'custrecord_aio_currency' },
                    { name: 'custrecord_aio_if_salesorder' },
                    { name: 'custrecord_aio_salesorder_type' },
                    ...
                    /** @Index 26 */
                    { name: fiedls.walmart_dev_accounts.walmart_api_client_id, join: fiedls.account.warmart_dev_account },
                    { name: fiedls.walmart_dev_accounts.walmart_api_client_sec, join: fiedls.account.warmart_dev_account },
                    /** @index 28 */
                    { name: fiedls.account.post_order_if_search }
                ]
            }).run().each(function(rec) {
        ...
        getAuthByAccountId: function(account_id) {
            ...
            search.create({
                ...
                filters: [{ name: 'internalid', operator: 'is', values: account_id }],
                columns: [
                    { name: t2.walmart_consumer_id, join: t.warmart_dev_account },
                    { name: t2.walmart_private_id, join: t.warmart_dev_account },
                    { name: t2.walmart_api_header, join: t.warmart_dev_account },
                    { name: t2.walmart_api_client_id, join: t.warmart_dev_account },
                    { name: t2.walmart_api_client_sec, join: t.warmart_dev_account },
                ]
            }).run().each(function(rec) {
                auth = {
                    consumer_id: rec.getValue(rec.columns[0]),
        ...
        getWalmartRecentOrders: function(account, params, nextCursor, ids) {
            ...
            }).body), signature = _a.signature, timestamp = _a.timestamp, version = _a.version;
          ...
          var headers = {
            ...
            var _a = JSON.parse(https.post({
                ...
                headers: {
                    'Authorization': 'Basic ' + exports.utils.base64Encode(account.auth_meta.client_id + ':' + account.auth_meta.client_sec),
                    'Content-Type': 'application/x-www-form-urlencoded',
                    'Accept': 'application/json',
                    'WM_SVC.NAME': 'Walmart Marketplace',
                    'WM_QOS.CORRELATION_ID': '123456abcdef',
            ...
            var headers = {
                ...
                'Authorization': 'Basic ' + exports.utils.base64Encode(account.auth_meta.client_id + ':' + account.auth_meta.client_sec),
                'WM_SVC.NAME': 'Walmart Marketplace',
                'WM_SEC.ACCESS_TOKEN': _a.access_token,
                'WM_QOS.CORRELATION_ID': '123456abcdef'
            };
            var response = https.get({ url: url, headers: headers }).body;
            try {
                log.debug('response', response);
                ...
                list.elements.order.map(function(o) {
                    ...
                    o.orderLines.orderLine.map(function(line) {
                        items.push({
                            ...
                            taxamount: line.charges.charge.filter(function(c) { return c.tax && c.tax.hasOwnProperty('taxAmount'); }).reduce(function(p, c) { return p + c.tax.taxAmount.amount; }, 0),
                        });
                ...
                if (list.meta.nextCursor) {
                    exports.walmart.getWalmartRecentOrders(account, params, list.meta.nextCursor).map(function(order) { return orders.push(order); });
                }
            } catch (err) {
        ...
        uploadTracking: function(account_id, rows) {
            ...
            if (auth) {
                rows.map(function(row) {
                    var iso_dt = format.parse({ type: format.Type.DATE, value: row.tran_date }),
                        carrier = ['UPS', 'USPS', 'FedEx', 'Airborne', 'OnTrac', 'DHL', 'NG', 'LS', 'UDS', 'UPSMI', 'FDX'].filter(function(c) { return c.toLowerCase() == row.carrier_method.toLowerCase(); }).shift(),
                        ...
                        return response;
                    // feeds.push(file.create({ name: row.account_id + "-" + row.tran_id + "-request.json", fileType: file.Type.JSON, contents: JSON.stringify(json, null, 2) }));
                    // feeds.push(file.create({ name: row.account_id + "-" + row.tran_id + "-response.json", fileType: file.Type.JSON, contents: JSON.stringify(JSON.parse(response), null, 2) }));
                });
                /** ???1?7?1?7?1?7?1?7?1?7?1?7????1?1?7?1?7 */
                email.send({
        ...
        gettoken: function(account_id, client_id) {
            return cache.getCache({ name: "WALMART_TOKEN_CACHE_V3" }).get({ key: "a_t_" + account_id + "_" + client_id, loader: exports.walmart.obtainToken, ttl: 900 });
        },
        obtainToken: function(ctx) {
            var c = cache.getCache({ name: "WALMART_TOKEN_CACHE_V3" }),
                auth = exports.walmart.getAuthByAccountId(Number(ctx.key.split('_')[2])),
                rtn = https.request({
                    url: exports.walmart._endpoint + "/token",
                    method: https.Method.POST,
                    headers: {
                        'Authorization': "Basic " + encode.convert({ inputEncoding: encode.Encoding.UTF_8, outputEncoding: encode.Encoding.BASE_64_URL_SAFE, string: (auth ? auth.client_id : '') + ":" + (auth ? auth.client_sec : '') }),
                        'Content-Type': 'application/x-www-form-urlencoded',
                        'Accept': 'application/json',
                        'WM_SVC.NAME': 'Walmart Marketplace',
                        'WM_QOS.CORRELATION_ID': '123456abcdef',
        ...
        apiRequest: function(account_id, auth, method, action, query, body) {
            ...
            var url = exports.walmart._endpoint + "/" + action + "?" + query,
                ...
                response = https.request({ url: url, method: method, headers: headers, body: body }).body;
                log.audit('url', url);
    ...
    exports.shopify = {
        ...
        listAccount: function() {
            ...
            search.create({
                type: 'customrecord_aio_account',
                filters: [
                    { name: 'custrecord_aio_marketplace', operator: 'anyof', values: 21 /* shopify */ },
                    { name: 'isinactive', operator: 'is', values: false },
                ],
                columns: [
                    { name: 'name' },
                    ...
                    { name: 'custrecord_aio_shopify_private_key', join: 'custrecord_aio_shopify_dev_account' },
                    { name: 'custrecord_aio_shopify_private_pwd', join: 'custrecord_aio_shopify_dev_account' },
                    { name: 'custrecord_aio_currency' },
                    { name: 'custrecord_aio_if_salesorder' },
                    { name: 'custrecord_aio_salesorder_type' },
                    { name: 'custrecord_aio_salesorder_form' },
            ...
            __.orders.map(function(o) {
                ...
                o.line_items.map(function(i) {
                    __items.push({
                        ...
                        taxcode: account.info.tax_item,
                        taxamount: i.tax_lines.map(function(l) { return Number(l.price); }).reduce(function(a, b) { return a + b; }, 0)
                    });
                });
                orders.push({
        ...
        apiRequest: function(auth, action, params) {
            if (params === void 0) { params = {}; }
            var querystring = Object.keys(params).map(function(_) { return _ + "=" + params[_]; }).join('&');
            var rtn = https.get({
                url: auth.domain + "/" + action + "?" + querystring,
                headers: {
                    Authorization: "Basic " + encode.convert({ string: auth.api_key + ":" + auth.password, inputEncoding: encode.Encoding.UTF_8, outputEncoding: encode.Encoding.BASE_64 })
                },
            }).body;
    ...
    exports.raqukenDE = {
        ...
        uploadTracking: function(account_id, data) {
            var key;
            search.create({
                type:'customrecord_aio_account',
                filters:[
                ...
                columns:[
                    /** @Index 0 * */
                    { name: 'custrecord_raqukende_key' }
                ]
            }).run().each(function(rec){
                key = rec.getValue(rec.columns[0]);
                return false;
            });
            if(key){
                var params = {
                    ...
                    "carrier" : data.service_name,
                    "tracking_number" : data.logistics_no,
                    "format" : 'json'
                } 
                log.debug('params',params);
                var url = 'http://webservice.rakuten.de/merchants/orders/addOrderTracking';
                var httpsUrls = exports.raqukenDE.sendUrl(url,params);
                log.debug('httpsUrls',httpsUrls);
                var httpResponse = http.post({
                    'url' : httpsUrls,
                    'body' : params
                });
                log.debug('httpResponse',JSON.parse(httpResponse.body).result);
                return JSON.parse(httpResponse.body).result;
            }
        },
    ...
    exports.raqukenJP = {
        ...
        uploadTracking: function(account_id, data){
            ...
            search.create({
                ...
                columns:[
                    /** @Index 0 * */
                    { name: 'custrecord_raqukenjp_appkey' },
                    { name: 'custrecord_raqukenjp_appsecret' }
                ]
            }).run().each(function(rec){
                licenseKey = rec.getValue(rec.columns[0]);
                serviceSecret = rec.getValue(rec.columns[1]);
                return false;
            });
            log.debug('data', data);
            log.debug('licenseKey', licenseKey);
            log.debug('serviceSecret', serviceSecret);
            if(licenseKey && serviceSecret){
                var hexEncodedString = encode.convert({
                    string: serviceSecret + ":" + licenseKey,
                    inputEncoding: encode.Encoding.UTF_8,
                    outputEncoding: encode.Encoding.BASE_64
                });
                var authorization = "ESA " + hexEncodedString;
                
                var headerChinaOrderInfo = {
                    "Authorization" : authorization,
                    //"Method" : "POST",
                    "Content-Type" : "application/Json; charset=utf-8",
                    "Accept" : "application/json",
                };
                var bodyChinaOrderInfo = {
                    "orderNumber" : data.order_no,
                    "BasketidModelList" : [{
                        "basketId" : data.basket_id,
                        "ShippingModelList" : [{
                            "deliveryCompany":data.service_name,
                            "shippingNumber":data.logistics_no,
                            "shippingDate":data.shiped_date.substring(0,10)//需要核对
                        }]
                    }]
                };
                log.debug('bodyChinaOrderInfo', bodyChinaOrderInfo);
                var httpUrls = "https://api.rms.rakuten.co.jp/es/2.0/order/updateOrderShipping/";
                var httpResponse = https.post({
                    url : httpUrls,
                    body : JSON.stringify(bodyChinaOrderInfo),
                    headers : headerChinaOrderInfo
                });
    ...
    exports.newegg = {
        fields: ['custrecord_newegg_dec_account'],
        uploadTracking: function(account_id, data) {
            var SellerID,Authorization,SecretKey;
            search.create({
                type:'customrecord_aio_account',
                filters:[
                    { name: 'internalid', operator: 'is', values: account_id },
                ...
                columns:[
                    /** @Index 0 * */
                    { name: 'custrecord_newegg_customer_sellerid', 		join: 'custrecord_newegg_dec_account' },
    	            { name: 'custrecord_newegg_customer_authorization', join: 'custrecord_newegg_dec_account' },
    	            { name: 'custrecord_newegg_customer_secret_key', 	join: 'custrecord_newegg_dec_account' }
                ]
            }).run().each(function(rec){
                SellerID = rec.getValue(rec.columns[0]);
                Authorization = rec.getValue(rec.columns[1]);
                SecretKey = rec.getValue(rec.columns[2]);
                return false;
            });
            ...
            if(Authorization && SecretKey && SellerID){
                var headerChinaOrderInfo = {
                    // appkey appSecret
                    "Authorization" : Authorization,
                    "SecretKey" : SecretKey,
                ...
                var bodyChinaOrderInfo = {
                    ...
                    "Value": {
                        "Shipment": {
                            "Header": {
                                "SellerID": SellerID,
                                "SONumber": data.order_no
                            },
                            "PackageList": {
                                "Package": [
                                    {
                                        "TrackingNumber": data.logistics_no,
                                        "ShipCarrier": data.service_name,
                ...
                log.debug('bodyChinaOrderInfo',bodyChinaOrderInfo);
                var httpUrls = "https://api.newegg.com/marketplace/ordermgmt/orderstatus/orders/" + data.order_no + "?sellerid="+SellerID;
                log.debug('httpUrls',httpUrls);
                var httpResponse = https.put({
                    url : httpUrls,
                    body : JSON.stringify(bodyChinaOrderInfo),
                    headers : headerChinaOrderInfo
                });
    ...
    exports.aliexpress = {
        fields: ['custrecord_aliexpress_dev_account'],
        uploadTracking: function(account_id, data) {
            var consumer_appkey,consumer_appsecret,consumer_seller_id;
            search.create({
                type:'customrecord_aio_account',
                filters:[
                    { name: 'internalid', operator: 'is', values: account_id },
                ...
                columns:[
                    /** @Index 0 * */
                    { name: 'custrecord_aliexpress_customer_app_key', join: 'custrecord_aliexpress_dev_account' },
                    { name: 'custrecord_aliexpress_app_secret', join: 'custrecord_aliexpress_dev_account' },
                    { name: 'custrecord_aliexpress_seller_id', 	join: 'custrecord_aliexpress_dev_account' }
                ]
            }).run().each(function(rec){
                consumer_appkey = rec.getValue(rec.columns[0]);
                consumer_appsecret = rec.getValue(rec.columns[1]);
                consumer_seller_id = rec.getValue(rec.columns[2]);
                return false;
            });
            if(consumer_appkey && consumer_appsecret && consumer_seller_id){
                log.debug('consumer_appkey',consumer_appkey);
                log.debug('consumer_appsecret',consumer_appsecret);
                log.debug('consumer_seller_id',consumer_seller_id);

                var method = 'aliexpress.logistics.sellershipmentfortop';
                var app_key = consumer_appkey;
                var app_secret = consumer_appsecret;
                var target_app_key = consumer_appkey;
                var sign_method='md5';     
                var currentTime = new Date(+new Date()+8*3600*1000).toISOString().replace(/T/g,' ').replace(/\.[\d]{3}Z/,'');
                var timestamp = currentTime;  
                var format = 'json';
                var v ='2.0';
                var url = 'http://qimen.api.taobao.com/top/router/qm';
                var id = consumer_seller_id;
                var send_type;
                if(data.upload_is_all == true){
                    send_type = 'all';
                }else{
                    send_type = 'part';
                }
                var body = {
                    "logistics_no":data.logistics_no,//运单号
                    "send_type":send_type,//申明发货类型all为全部发货，part为部分发货
                    "out_ref":data.order_no,//交易订单号
                    "service_name":data.service_name //物流服务名称
                };
                var param1 = JSON.stringify(body);
                var param = {
                    'id' : id,
                    'method': method,
                    'app_key' : app_key,
                    ...
                    'send_type':'all',
                    'out_ref':data.order_no,
                    'service_name':data.service_name
                };
                log.debug('param',param);
                var baseParamStr = exports.aliexpress.parseObj(param);
                var commonsign = app_secret + baseParamStr + app_secret;
                var sign = hex_md5(commonsign).toString(16).toUpperCase();//toString(16) 16进制，toUpperCase 变大写
                var jointUrl = exports.aliexpress.sendUrl(url,param,sign);
                try{
                    var httpResponse = http.post({
                        'url' : jointUrl,
                        'body' : param1
                ...
                return JSON.parse(httpResponse.body).response;
            }
        },
        sendUrl:function(url, bodyStr,sign) {
            var arr = [];
            ...
            for ( var i in arr) {
                if (i < arr.length - 1){
                    if(arr[i] =='sign_method' && sign != ''&& sign != null){
                        str +=  'sign=' + sign  + '&' + arr[i] + '=' + encodeURIComponent(bodyStr[arr[i]]) + '&'
                    }
                    else{
                        str +=  arr[i] + '=' + encodeURIComponent(bodyStr[arr[i]]) + '&'
                    }
                }else{
                    str += arr[i] + '=' + bodyStr[arr[i]]
                }
            }
            var url = url + '?' + str;
            return url;
        },
        parseObj:function(bodyStr) {
            var strArr = [];
            for ( var m in bodyStr) {
                strArr.push(m);
            }
            strArr.sort();
            var str = '';
            for ( var n in strArr) {
                str += strArr[n] + bodyStr[strArr[n]];
    ...
    exports.walmartUpload = {
        uploadTracking: function(account_id, data) {
            ...
            //         { name: 'custrecord_aio_walmart_private_id', join: 'custrecord_aio_warmart_dev_account' },
            //         { name: 'custrecord_aio_walmart_api_header', join: 'custrecord_aio_warmart_dev_account' },
            //         { name: 'custrecord_aio_walmart_api_client_id', join: 'custrecord_aio_warmart_dev_account' },
            //         { name: 'custrecord_aio_walmart_api_client_sec', join: 'custrecord_aio_warmart_dev_account' },
            //     ]
            // }).run().each(function(rec) {
            //     auth = {
            //         consumer_id: rec.getValue(rec.columns[0]),
            ...
            if (auth) {
                var json = {
                    "orderShipment": {
                        "orderLines": {
                            "orderLine": data.item_list
                        }
                    }
                },
                response = exports.walmart.apiRequest(account_id, auth, 'POST', "orders/" + data.order_no + "/shipping", '', JSON.stringify(json, null, 2));
                log.debug('json',json);
                return response;
            }
        } 
