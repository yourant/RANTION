        ...
        && acc_skus[key] == SKUIds[z]['forecast_account']
          ...
          if (result[a]['data_type'] == 3) { // 店铺净需求量
            ...
            week_rs.map(function(wek){
              ...
              var x1 =  data_arr[need1_zl]['weekArray'][wek]["qty"]; ; //需求预测 
              var x2 =  data_arr[need2_zl]['weekArray'][wek]["qty"]; ; //库存量
              var x3 =  data_arr[need3_zl]['weekArray'][wek]["qty"]; ; //在途量
