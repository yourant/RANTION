 ...
 * @LastEditTime   : 2020-05-19 11:29:28
 * @LastEditors    : Li
 * @Description    : FBM发货平台发运处理功能(小包)
 * @FilePath       : \Rantion\fulfillment.record\dps.fulfillment.record.full.invoice.ue copy.js
...
define(['N/record', 'N/search', 'N/log',
    ...
    function (record, search, log, jetstar, openapi, yanwen, endicia, Moment, http, file) {
        ...
        function beforeLoad(context) {
            ...
            if (action_type == 'view') {
                ...
                log.debug('beforeLoad', small_status);
                if (small_status == 2) {
                    form.addButton({
