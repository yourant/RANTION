 ...
 * @LastEditTime   : 2020-05-19 10:03:47
 * @LastEditors    : Li
 * @Description    : 发运记录 大包
 ...
 */
define(['N/record', 'N/search', '../Helper/core.min', 'N/log', 'N/http'], function (record, search, core, log, http) {
    ...
    function afterSubmit(context) {
        ...
        var type = 10;
        if (rec_status == 11 && tranor_type == 2) {
            type = 20;
            ...
            // Name Yes Maximum: 50 characters Type: xs: string
            // AddressLine1 Yes Maximum: 180 characters Type: xs: string
            // AddressLine2  No Maximum: 60 characters Type: xs: string
            // City Yes Maximum: 30 characters Type: xs: string
            // DistrictOrCounty No Maximum: 25 characters Type: xs: string
            // StateOrProvinceCode No Type: xs: string
            // CountryCode Yes A two - character country code, in ISO 3166 - 1 alpha - 2 format.Type: xs: string
            // PostalCode No  Maximum: 30 characters Type: xs: string
