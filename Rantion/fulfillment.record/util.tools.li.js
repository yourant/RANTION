/*
 * @Author         : Li
 * @Date           : 2020-05-16 15:46:52
 * @LastEditTime   : 2020-05-16 15:49:02
 * @LastEditors    : Li
 * @Description    : 
 * @FilePath       : \Rantion\fulfillment.record\util.tools.li.js
 * @可以输入预定的版权声明、个性签名、空行等
 */
(cryptoJS, config, search, record, xml, https, crypto, file, encode, runtime)
