 ...
 * @LastEditTime   : 2020-07-10 22:28:09
 * @LastEditors    : Li
 * @Description    : 
 * @FilePath       : \Rantion\pr\pr_lan.js
...
define(['N/runtime'], function (runtime) {
    ...
    var prBatchImportParam = {
        'zh_CN': {
            ...
            // 'custpage_batch_import_purchase_type': '采购方式',
            ...
            'custpage_batch_import_demand_number': '需求单号'
        },
        'en_US': {
            ...
            'custpage_batch_import_demand_number': 'Demand Number',
        }
    };
