            ...
            try {
                ...
                search.create({
                    ...
                    columns: [
                        ...
                        { name: 'transferlocation', join: 'custrecord_dps_shipping_rec_order_num' },
                    ...
                    from_location = result.getValue({ name: 'transferlocation', join: 'custrecord_dps_shipping_rec_order_num' });
                    to_location = result.getValue({ name: 'custbody_actual_target_warehouse', join: 'custrecord_dps_shipping_rec_order_num' });
                ...
                if (!to_id) {
                    ...
                    search.create({
                        ...
                        filters: [
                            { name: 'custrecord_dps_shipping_record_parentrec', operator: 'anyof', values: shipping_id }
                        ],
                        columns: [
                    ...
                    transferorder_c_rec.setValue({ fieldId: 'custbody_dps_end_location', value: to_location });
                    transferorder_c_rec.setValue({ fieldId: 'transferlocation', value: to_location });
        ...
        function createItemReceipt(po_id, item) {
            ...
            item.forEach(function (line) {
                for (var ss = 0, ssLen = line.detailRecordList.length; ss < ssLen; ss++) {
                    ...
                    var lineIR = objRecord.getLineCount({ sublistId: 'item' });
                    for (var i = 0; i < lineIR; i++) {
                        objRecord.setSublistValue({ sublistId: 'item', fieldId: 'itemreceive', value: false, line: i });
                    }
        ...
        function returnInfo(context) {
            ...
            search.create({
                ...
                filters: [
                    ...
                    { name: 'internalid', operator: 'anyof', values: sourceNo }
                ],
