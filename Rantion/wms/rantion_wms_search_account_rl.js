...
define(['N/search', 'N/http', 'N/record'], function(search, http, record) {
    ...
    function _post(context) {
        ...
        var mySearch = search.create({
            ...
            columns: [
                'name', 'internalid', 'custrecord_aio_marketplace', 'custrecord_aio_currency', 
                'custrecord_aio_subsidiary', 'custrecord_aio_eb_registered_county', 
                'custrecord_aio_fbaorder_location', 'custrecord_aio_salesorder_location', 
                'custrecord_aio_account_region', 'custrecord_aio_enabled_sites', 
                'custrecord_aio_mws_auth_token', 'custrecord_aio_dev_account', 'custrecord_aio_seller_id'
            ]
        });
