 ...
 * @Author         : Li
 * @Version        : 1.0
 * @Date           : 2020-07-08 16:56:57
 * @LastEditTime   : 2020-07-08 16:56:57
 * @LastEditors    : Li
 * @Description    : 
 * @FilePath       : \douples_amazon\AHSJD.js
...
define(['N/search', 'N/record'],
    function (search, record) {
        ...
        function execute(context) {
            ...
            var limi = 2000
            // search.load({
            //     id: "customsearch476"  //搜索日记账 的custbody_jourentry_relative_checked is false
            ...
            try {
                jo2_id.map(function (jo2) {
                    ...
                    for (var key in inv_objs) {
                        inv_objs[key].map(function (inv_id) {
                            record.submitFields({
                                type: "invoice",
                                id: inv_id,
                                values: {
        ...
        function setTruesettlment(settlement_ids) {
            var fils = [
                ...
                fils2 = [],
                set_arrys = []
            var settlement_ids_len = settlement_ids.length,
                lse = 0
