...
>>>>>>> 53de782e3fa33a9643374f54a4c795ab44328e36
        ...
        GetPackageLabels: function (account_id, shipment_id, pagetype, numberofpackages) {
            ...
            if (auth) {
                ...
                var response = exports.amazon.mwsRequestMaker(auth, 'GetPackageLabels', '2010-10-01', params_3, '/FulfillmentInboundShipment/2010-10-01');
                log.debug('response', response);
                var res = xml.Parser.fromString({
                    text: response
                });

                var TransportDocument = exports.utils.getTextContentSafe(res, 'TransportDocument');
                var Checksum = exports.utils.getTextContentSafe(res, 'Checksum');

                var fileObj = file.create({
                    name: shipment_id + '-' + Checksum,
                    content: TransportDocument,
