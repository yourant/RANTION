...
define(['require', 'exports', 'N/email', 'N/error', 'N/https', 'N/log', 'N/file', 'N/format', 'N/cache', 'N/runtime', 'N/crypto', 'N/search', 'N/record', 'N/encode', 'N/ui/serverWidget', 'N/xml', './Moment.min', './CryptoJS.min', './Papaparse.min', './fields.min'], function (require, exports, email, error, https, log, file, format, cache, runtime, crypto, search, record, encode, ui, xml, moment, cryptoJS, papa, fiedls) {
    ...
    (function (enums) {
        ...
        (function (report_type) {
            ...
            report_type[report_type['_GET_FBA_FULFILLMENT_MONTHLY_INVENTORY_DATA_'] = 19] = '_GET_FBA_FULFILLMENT_MONTHLY_INVENTORY_DATA_'
            report_type[report_type['_GET_FBA_FULFILLMENT_INVENTORY_ADJUSTMENTS_DATA_'] = 20] = '_GET_FBA_FULFILLMENT_INVENTORY_ADJUSTMENTS_DATA_'
    ...
    (function (consts) {
        ...
        consts.fieldsMapping = {
            '_GET_FBA_FULFILLMENT_MONTHLY_INVENTORY_DATA_': {
                'record_type_id': 'customrecord_amazon_monthinventory_rep',
                'mapping': {
                    'custrecord_moninv_account': 'account',
                    'custrecord_moninv_reportid': 'report-id',
                    // 'custrecord_moninv_month': 'month',
                    'custrecord_moninv_month_txt': 'month',
                    'custrecord_moninv_fnsku': 'fnsku',
                    'custrecord_moninv_sku': 'sku',
                    'custrecord_moninv_product_name': 'product-name',
                    'custrecord_moninv_average_quantity': 'average-quantity',
                    'custrecord_moninv_end_quantity': 'end-quantity',
                    'custrecord_moninv_fulfillment_center_id': 'fulfillment-center-id',
                    'custrecord_moninv_detailed_disposition': 'detailed-disposition',
                    'custrecord_moninv_country': 'country'
                }
            },
            '_GET_FBA_FULFILLMENT_INVENTORY_ADJUSTMENTS_DATA_': {
                'record_type_id': 'customrecord_amazon_adjust_inventory_rep',
                'date_key': 'adjusted-date',
                'mapping': {
                    'custrecord_adjusts_account': 'account',
                    'custrecord_adjusts_reportid': 'report-id',
                    'custrecord_adjusts_adjusted_date': 'adjusted-date',
                    'custrecord_adjusts_adjusted_date_txt': 'adjusted-date-txt',
                    'custrecord_adjusts_transaction_item_id': 'transaction-item-id',
                    'custrecord_adjusts_fnsku': 'fnsku',
                    'custrecord_adjusts_sku': 'sku',
                    'custrecord_adjusts_product_name': 'product-name',
                    'custrecord_adjusts_fulfillment_center_id': 'fulfillment-center-id',
                    'custrecord_invful_quantity': 'quantity',
                    'custrecord_adjusts_reason': 'reason'
                }
            },
            '_GET_FBA_FULFILLMENT_INVENTORY_SUMMARY_DATA_': {
                'record_type_id': 'customrecord_amazon_fulfill_invtory_rep',
                'date_key': 'snapshot-date',
                'mapping': {
                    'custrecord_invful_account': 'account',
                    'custrecord_invful_reportid': 'report-id',
                    'custrecord_invful_snapshot_date': 'snapshot-date',
                    'custrecord_invful_snapshot_date_txt': 'snapshot-date-txt',
                    'custrecord_invful_transation_type': 'transaction-type',
                    'custrecord_invful_fnsku': 'fnsku',
                    'custrecord_invful_sku': 'sku',
                    'custrecord_invful_product_name': 'product-name',
                    'custrecord_invful_fulfillment_center_id': 'fulfillment-center-id',
                    'custrecord_invful_quantity': 'quantity',
                    'custrecord_invful_disposition': 'disposition'
                }
            },
            ...
            '_GET_FBA_FULFILLMENT_REMOVAL_ORDER_DETAIL_DATA_': {
                ...
                'mapping': {
                    ...
                    'custrecord_aio_removal_request_date_txt': 'request-date-txt',
            ...
            '_GET_FBA_FULFILLMENT_REMOVAL_SHIPMENT_DETAIL_DATA_': {
                ...
                'date_key': 'shipment-date',
                'mapping': {
                    'custrecord_remo_shipment_account': 'account',
                    'custrecord_aio_rmv_report_id': 'report-id',
                    'custrecord_aio_rmv_request_date': 'request-date',
                    'custrecord_aio_rmv_order_id': 'order-id',
                    'custrecord_aio_removal_shoment_date': 'shipment-date',
                    'custrecord_aio_rmv_date': 'shipment-date-txt',
    ...
    exports.amazon = {
        ...
        getAccountList: function (group) {
            ...
            search.create({
                ...
                columns: [
                    ...
                    /** @index 48 */
                    {
                        name: fiedls.account.if_post_order_fulfillment // 48
                    },
                    {
        ...
        GetFeedSubmissionResult: function (account_id, submission_id) {
            var account = exports.amazon.getAuthByAccountId(account_id)

            var response = response = exports.amazon.mwsRequestMaker(account, 'GetFeedSubmissionResult', '2009-01-01', {
                FeedSubmissionId: submission_id
            }, '/Feeds/2009-01-01/')

            log.debug('获取提交结果 response', response)
            record.submitFields({
        ...
        getFeedSubmissionList: function (account_id, submission_ids) {
            var account = exports.amazon.getAuthByAccountId(account_id)
            var params = {
                'MaxCount': 100,
            ...
            var content = exports.amazon.mwsRequestMaker(account, 'GetFeedSubmissionList', '2009-01-01', params, '/Feeds/2009-01-01/'),
                res = xml.Parser.fromString({
                    text: content
                })
            var feeds = []
            ...
            feeds.map(function (feed) {
                search.create({
                    ...
                    var response = ''
                    if (feed.feed_processing_status == '_DONE_') {
                        // if (feed.feed_processing_status == '_DONE_' && "" + rec.getValue(rec.columns[0]) == '') {
                        response = exports.amazon.mwsRequestMaker(account, 'GetFeedSubmissionResult', '2009-01-01', {
                            FeedSubmissionId: feed.feed_submission_id
                        }, '/Feeds/2009-01-01/')
                        log.debug('获取feed 装箱信息 response', response)
                        var MessagesWithError, ResultMessageCode
                        if (response) {
                            var res = xml.Parser.fromString({
                                text: response
                            })
                            MessagesWithError = exports.utils.getTextContentSafe(res, 'MessagesWithError')
                            feed.MessagesWithError = MessagesWithError
                            ResultDescription = exports.utils.getTextContentSafe(res, 'ResultDescription')
                            feed.ResultDescription = ResultDescription
                        }
                        log.debug('MessagesWithError', MessagesWithError)
                        log.debug('获取 feed 结果 response', response)
                        record.submitFields({
                            type: exports.ns.amazon_feed._name,
                            id: rec.id,
                            values: {
        ...
        submitCartonContent: function (account_id, rec_id, shipment_id) {
            var auth = exports.amazon.getAuthByAccountId(account_id)
            ...
            if (auth) {
              ...
              */
              ...
              if (res.getElementsByTagName({
                ...
                feed.setValue({
                  fieldId: 'custrecord_dps_ship_record_big',
                  value: rec_id
                }); // 设置关联的大货发运记录
                feed.setValue({
                  fieldId: exports.ns.amazon_feed.feed_submission_id,
                ...
                if (feedId) {
                  ...
                  shipRec.setValue({
                    fieldId: 'custrecord_dps_upload_packing_rec',
                    value: feedId
                  })
                  shipRec.setText({
                    fieldId: 'custrecord_dps_amazon_press_status',
                    text: exports.utils.getTextContentSafe(res, 'FeedProcessingStatus')
                  })

                  var shipRec_id = shipRec.save()

                  log.debug('保存发运记录 shipRec_id', shipRec_id)

                  // record.submitFields({
                  //     type: 'customrecord_dps_shipping_record',
                  //     id: rec_id,
                  //     values: {
                  //         custrecord_dps_upload_packing_rec: feedId,
                  //         custrecord_dps_amazon_press_status
                  //     }
                  // })
        ...
        getPalletLabels: function (account_id, to_id, shipment_id) {
            var auth = exports.amazon.getAuthByAccountId(account_id),
                params = {
                    ShipmentId: shipment_id,
                    // PageType: 'PackageLabel_Plain_Paper',
                    // PageType: 'PackageLabel_A4_4', // 欧洲
                    PageType: 'PackageLabel_Letter_6', // 其他
                }
            if (auth) {
                /*
                var key_2 = 0
        ...
        GetPackageLabels: function (account_id, boxNo, shipment_id) {
            var checkArr = ['UK', 'DE', 'FR', 'ES', 'IT'],
                P_type = 'PackageLabel_Letter_6'
            var auth = exports.amazon.getAuthByAccountId(account_id)

            log.debug('auth', auth)

            var a_name = auth.name,
                a = a_name.split('.')
            if (checkArr.indexOf(a[a.length - 1]) > -1) {
                P_type = 'PackageLabel_A4_4'; // 欧洲
            }
            var params = {
                ShipmentId: shipment_id,
                PageType: P_type
            ...
            if (auth) {
                params['NumberOfPackages'] = boxNo
                var content = exports.amazon.mwsRequestMaker(auth, 'GetPackageLabels', '2010-10-01', params, '/FulfillmentInboundShipment/2010-10-01/'),
                    res = xml.Parser.fromString({
                        text: content
                    })
                if (res.getElementsByTagName({
