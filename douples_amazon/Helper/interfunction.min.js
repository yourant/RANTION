  ...
  function (record, search, core, format, moment, runtime, log) {
    ...
    function getSearchAccount (sellerid) {
      ...
      search.create({
        ...
        filters: [{ name: 'custrecord_aio_seller_id', operator: 'is', values: sellerid }],        columns: [
    ...
    function CheckJO (orderid, settlmentid, settlement_ids, memomain, acc, merchant_order_id) {
      ...
      if (!orderid && merchant_order_id) {
        fils.push({
          name: 'custbody_setl_merchant_order_id',
          operator: 'is',
      ...
      if (incomeaccount) {
        ...
        search.create({
          ...
          unfee_rec = record.load({
            type: 'customrecord_amazon_config_defer',id: e.id
          })
        })
        if (!unfee_rec) {
