    ...
    function (record, search, core, format, moment, runtime, log) {
        ...
        */
        ...
        function getFormatedDate(postDate, endDate, depositDate, startDate,is_tran) {
            ...
            var o_date = moment.utc("2020/05/31 16:00:00").toDate()   //UTC  北京时间的6月1日 00：00：00
            ...
            if (!depositDate) {
                ...
                if (o_date > depostie && is_tran) {
                    return "2"
                }
                log.debug("是收款 " + depostie,"depositDate: "+depositDate +"",+FF.indexOf("YYYY"))
                rs = {
                    "ps": "deposit",
