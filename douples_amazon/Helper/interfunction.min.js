...
define(["N/record", "N/search", "./core.min", "N/format", './Moment.min', "N/runtime", "N/log"],
    function (record, search, core, format, moment, runtime, log) {
        ...
        * @param {*} acc_search 
        */
       function  SearchSO(order_id,merchant_order_id,acc_search,cl_date){
        var fils =[
          ...
          search.create({
            ...
            rs["so_id"] =rec.id
            rs["acc"] =rec.getValue('custbody_aio_account')
            rs["acc_text"] =rec.getText('custbody_aio_account')
        ...
        function GetstoreInEU(acc, marketplace_name, acc_text) {
            var sellerid, account = {}, feck = false
            search.create({
                type: "customrecord_aio_account",
                filters: [
            ...
            search.create({
                ...
                if (marketplace_name.toUpperCase() == e.getText("custrecord_aio_enabled_sites").split(" ")[1]) {
                    account = {
                        "acc": e.id,
    ...
    */
        ...
        function getFormatedDate(postDate, endDate, depositDate, startDate) {
            ...
            var o_date = moment.utc("2020/05/01 00:00:00").toDate()   //UTC 
            ...
            if (!depositDate) {
                ...
                var Year = ender_date.split(" ")[0].split(/[^0-9]/g)[FF.indexOf("YYYY")]
                log.debug("Day", Day)
                ...
                if (Day > 3 && Month > starter_date.split(" ")[0].split(/[^0-9]/g)[FF.indexOf("M")]) {  //判断endate跨月且大于等于3日就取endDate
                   ...
                   */
                    ...
                    rs = {
                        ...
                        "Year": poster_date.split(" ")[0].split(/[^0-9]/g)[FF.indexOf("YYYY")],
                        "Day": poster_date.split(" ")[0].split(/[^0-9]/g)[FF.indexOf("D")],
                        "Month": poster_date.split(" ")[0].split(/[^0-9]/g)[FF.indexOf("M")]
                    }
                }
            } else {
                //收款时间 depositDate
                ...
                log.debug("是收款" + depostie, FF.indexOf("YYYY"))
                rs = {
                    "ps": "deposit",
                    "date": depostie.split(" ")[0],
                    "Year": depostie.split(" ")[0].split(/[^0-9]/g)[FF.indexOf("YYYY")],
                    "Day": depostie.split(" ")[0].split(/[^0-9]/g)[FF.indexOf("D")],
                    "Month": depostie.split(" ")[0].split(/[^0-9]/g)[FF.indexOf("M")]
                }
            }
