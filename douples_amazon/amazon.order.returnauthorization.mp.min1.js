 ...
 */
define(['./Helper/interfunction.min', 'N/runtime', 'N/format', './Helper/Moment.min', 'require', 'exports', './Helper/core.min',
    'N/log', 'N/search', 'N/record', './Helper/fields.min'
    ...
    exports.getInputData = function() {
        ...
        var acc = runtime.getCurrentScript().getParameter({ name: 'custscript_return_acc' });
        var group = runtime.getCurrentScript().getParameter({ name: 'custscript_return_accgroup' });


        var _start_date = runtime.getCurrentScript().getParameter({ name: 'custscript_amazon_return_mp_start_date' });
        var _end_date = runtime.getCurrentScript().getParameter({ name: 'custscript_amazon_return_mp_end_date' });
        ...
        search.create({
            ...
            returns.push({
                ...
                acc_text: rec.getText('custrecord_aio_b2c_return_aio_account'),
    ...
    exports.map = function(ctx) {
        ...
        try {
            ...
            return_date_txt = dealWithDate(return_date_txt, acc_text); // 用于处理JP / AU 店铺的时区问题
    ...
    function createSOTRMissingOrder(type, orderid, reason, date, acc) {
        ...
        type ? mo.setValue({ fieldId: 'custrecord_tr_missing_order_type', value: type }) : ''; // ����
