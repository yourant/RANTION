 ...
 * @LastEditTime   : 2020-07-07 16:48:33
 * @LastEditors    : Li
 * @Description    : 
...
define(["N/format", "N/runtime", "./Helper/core.min", "./Helper/Moment.min", "N/log", "N/search",
    ...
    function createFulfillmentRecord(soid, sku) {
        ...
        search.create({
            ...
            columns: ['location', 'item', 'quantity', 'custbody_aio_api_content', 'tranid', 'otherrefnum', 'custbody_aio_account']
        }).run().each(function (rec) {
    ...
    function searchCusContactPerson(o, consumer_id) {
        ...
        if (o.shipping_address && o.buyer_email) {
            ...
            if (o.shipping_address.country_code) {
                var coun = searchCreateCountry(o.shipping_address.country_code);
                c.setValue({
