 ...
 * @Author         : Li
 * @Version        : 1.0
 * @Date           : 2020-07-01 19:45:00
 * @LastEditTime   : 2020-07-01 20:12:20
 * @LastEditors    : Li
 * @Description    : 
 * @FilePath       : \dps.li.test.cs.js
 ...
 */
define(['N/url', 'N/https', 'N/currentRecord', 'N/ui/dialog', 'N/log'], function (url, https, currentRecord, dialog, log) {
    ...
    function pageInit(scriptContext) {
        ...
        log.debug("pageInit", scriptContext.currentRecord);

        console.log("pageInit", scriptContext.currentRecord)
