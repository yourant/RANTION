...
var yanwenApi = {
        ...
        if (response.code == 200) {
            ...
            res.getElementsByTagName({
                ...
                channelTypeArray.push({
                    Id: node.getElementsByTagName({
                        tagName: 'Id'
                    })[0].textContent,
                    Name: node.getElementsByTagName({
                        tagName: 'Name'
                    })[0].textContent,
                    Status: node.getElementsByTagName({
                        tagName: 'Status'
                    })[0].textContent
                })
                return true
    ...
    Create: function (rec, now) {
        ...
        if (reqParam.code == 200) {
            response = this.POST(yanwenApi.url.create, reqParam.data)
        } else {
            return reqParam
        }
                ...
                for (var key in YanWenDict) {
                    ...
                    if (key == 'Receiver' || key == "GoodsName" || key == "Sender") {
                        if (node.getElementsByTagName({
                            ...
                            //目前只取第一个
                            var secondNode = node.getElementsByTagName({
                                tagName: key
                            })[0]
                            var secondParam = {}
                            for (sencondKey in dict) {
                                secondParam[sencondKey] = secondNode.getElementsByTagName({
                                    tagName: sencondKey
                                }).length ? secondNode.getElementsByTagName({
                                    tagName: sencondKey
                                })[0].textContent : ''
                            }
                        ...
                        resultParam[key] = node.getElementsByTagName({
                            tagName: key
        ...
        if (response.code == 200) {
            ...
            if (SuccessResult == "true") {
                ...
                for (var i in backKey) {
                    resultValue[backKey[i]] = res.getElementsByTagName({
                            tagName: backKey[i]
                        }).length > 0 ?
                        res.getElementsByTagName({
                            tagName: backKey[i]
        ...
        if (response.code == 200) {
            ...
            res.getElementsByTagName({
                ...
                countryArray.push({
                    ...
                    RegionCh: node.getElementsByTagName({
                        tagName: 'RegionCh'
                    })[0].textContent,
                    RegionEn: node.getElementsByTagName({
                        tagName: 'RegionEn'
                    })[0].textContent,
                    RegionCode: node.getElementsByTagName({
                        tagName: 'RegionCode'
                    })[0].textContent
                })
                return true
    ...
    CreateParam: function (rec, now) {
        ...
        var ExpressTypeElem = reqParamXml.getElementsByTagName({
            tagName: 'ExpressType'
        })[0]
        //添加客户号
            ...
            if (key == 'Receiver') {
                ...
                for (var i = 0; i < line; i++) {
                    ...
                    if (itemId) {
                        ...
                        //数量获取
                        itemNum[itemId] = rec.getSublistValue({
                            sublistId: subKey,
    ...
    CreateOnlineParam: function (rec) {
        ...
        var GoodsElem = reqParamXml.getElementsByTagName({
            tagName: 'GoodNames'
        })[0]
...
var YanWenDict = {
    ...
    Channel: {
        key_ns: "custrecord_dps_ship_small_channelservice",
        help: "发货方式",
        require: true,
        getType: "value",
        parseType: "customrecord_logistics_service",
        parseId: "custrecord_ls_service_code"
    },
    UserOrderNumber: {
        key_ns: "custrecord_dps_ship_order_number",
        help: "客户订单号",
        require: false,
        getType: "value"
    },
    SendDate: {
        key_ns: "custrecord_dps_ship_small_shipping_date",
        help: "发货日期",
        require: true,
        getType: "value",
        changeType: "date"
    ...
    Receiver: {
        ...
        Name: {
            key_ns: "custrecord_dps_ship_small_recipient",
            help: "收货人-姓名",
            require: true,
            getType: "value"
        },
        Phone: {
            key_ns: "custrecord_dps_ship_small_phone",
            help: " 收货人-座机，手机。美国专线至少填一项",
            require: false,
            getType: "value"
        },
        Mobile: {
        ...
        Country: {
            key_ns: "custrecord_dps_recipient_country",
            help: "收货人-国家",
            require: false,
            getType: "text"
        },
        Postcode: {
            key_ns: "custrecord_dps_recipien_code",
            help: "收货人-邮编",
            require: true,
            getType: "value"
        },
        State: {
            key_ns: "custrecord_dps_s_state",
            help: "收货人-州",
            require: true,
            getType: "value"
        },
        City: {
            key_ns: "custrecord_dps_recipient_city",
            help: "收货人-城市",
            require: true,
            getType: "value"
        },
        Address1: {
            key_ns: "custrecord_dps_street1",
            help: "收货人-地址1",
            require: true,
            getType: "value"
        },
    ...
    GoodsName: {
        ...
        NameCh: {
            key_ns: "custitem_dps_skuchiense",
            help: "商品中文品名",
            require: true,
            getType: "value",
            itemType: "item"
        ...
        NameEn: {
            key_ns: "custitem_dps_skuenglish",
            help: "商品英文品名",
            require: true,
            getType: "value",
            itemType: "item"
        ...
        Weight: {
            key_ns: "custitem_dps_heavy2",
            help: "包裹总重量（单位是：克；不能有小数）",
            require: true,
            getType: "value",
            itemType: "item"
        },
        DeclaredValue: {
            key_ns: "custrecord_dps_declared_value",
            help: "申报总价值",
            require: true,
            getType: "value"
        },
        DeclaredCurrency: {
            key_ns: "custrecord_dps_declare_currency",
            help: "申报币种。支持的值：USD,EUR,GBP,CNY,AUD。",
            require: false,
            getType: "text"
        },
        MoreGoodsName: {
        ...
        HsCode: {
            key_ns: "",
            help: "商品海关编码,香港FedEx经济必填。",
            require: false,
            getType: "value"
        },
        ProductBrand: {
            key_ns: "",
            help: "产品品牌，中俄SPSR专线此项必填",
            require: false,
            getType: "value"
        },
        ProductSize: {
            key_ns: "",
            help: "产品尺寸，中俄SPSR专线此项必填",
            require: false,
            getType: "value"
        },
        ProductColor: {
            key_ns: "",
            help: "产品颜色，中俄SPSR专线此项必填",
            require: false,
            getType: "value"
        },
        ProductMaterial: {
            key_ns: "",
            help: "产品材质，中俄SPSR专线此项必填",
            require: false
        }
    },
    Sender: {
...
var onlineDataDict = {
    ...
    ChannelType: {
        key_ns: "",
        help: "发货方式。(支持的值：EUB线上-北京仓 , WISH邮-挂号-北京仓 , 速卖通中邮-平邮-北京仓 , WISH邮-挂号-南京仓 , WISH邮-平邮-北京仓 , WISH邮-平邮-南京仓 , 速卖通中邮-挂号-北京仓)",
        require: true
    },
    Country: {
        key_ns: "",
    ...
    GoodNames: {
        NameCh: {
            key_ns: "",
            help: "中文品名。以下渠道必填：WISH邮-挂号-北京仓，速卖通中邮-平邮-北京仓，WISH邮-平邮-北京仓，速卖通中邮-挂号-北京仓 ",
            require: true
        },
        NameEn: {
            key_ns: "",
            help: "英文品名 。以下渠道必填：WISH邮-挂号-北京仓，速卖通中邮-平邮-北京仓，WISH邮-平邮-北京仓，速卖通中邮-挂号-北京仓",
            require: true
        },
        DeclaredValue: {
            key_ns: "",
            help: "申报价值。以下渠道必填：WISH邮-挂号-北京仓，速卖通中邮-平邮-北京仓，WISH邮-平邮-北京仓，速卖通中邮-挂号-北京仓",
            require: true
        },
        DeclaredCurrency: {
            key_ns: "",
            help: "币种。以下渠道必填：WISH邮-挂号-北京仓，速卖通中邮-平邮-北京仓，WISH邮-平邮-北京仓，速卖通中邮-挂号-北京仓",
            require: true
        }
    }
}
